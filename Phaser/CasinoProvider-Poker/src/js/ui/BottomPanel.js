...
class BottomPanel {
  constructor(_scene) {
    ...
    this.BetButtonXpos = {
      halfPotButtonX: -254,
      threeFourthButtonX: -84,
      potButtonX: 84,
      raiseAllInButton: 254,
      foldButtonX: 248,
      callButtonX: 57,
      checkButtonX: 57,
      allInButtonX: -30
  ...
  ShowAllInButtonForPlayer(_status) {
    this.allInButtonShowingStatus = _status;
    if (_status) {
      if (this.BetButtonXpos.foldButtonX === 248) {
        this.BetButtonXpos.foldButtonX = 168;
      ...
      this.BetButtonXpos.foldButtonX = 248;
      this.ResizeFoldButton(this.currWidth, this.currHeight, this.currScale);
      this.HideAllInButton();
    }
  };
  ...
  //#region Raise Sections Resize
  RaiseBetButtonPosReset(_trueCount, _buttonStatuses) {
    const keys = Object.keys(this.BetButtonXpos);
    const config = {
      4: { widthGap: -254, containerPosX: 834 },
      3: { widthGap: -170, containerPosX: 750 },
      2: { widthGap: 85, containerPosX: 500 },
      1: { widthGap: 85, containerPosX: 500 }
    };
    const { containerPosX } = config[_trueCount] || { widthGap: 85, containerPosX: 500 };
    let { widthGap } = config[_trueCount] || { widthGap: 85, containerPosX: 500 };
    ...
    for (let index = 0; index < _buttonStatuses.length; index++) {
      if (_buttonStatuses[index] === true) {
        this.BetButtonXpos[keys[index]] = widthGap;
        widthGap += 170;
      }
    }
  ...
  ResizeFoldButton(_newWidth, _newHeight, _newScale) {
    ...
    this.foldButton.setPosition(((_newWidth / 2) - (this.BetButtonXpos.foldButtonX * _newScale)) + (this.foldButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.foldButton.getHeight() * 0.5));
  ...
  ResizeCallButton(_newWidth, _newHeight, _newScale) {
    ...
    this.callButton.setPosition(((_newWidth / 2) - (this.BetButtonXpos.callButtonX * _newScale)) + (this.callButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.callButton.getHeight() * 0.5));
  ...
  ResizeAllInButton(_newWidth, _newHeight, _newScale) {
    ...
    this.allinButton.setPosition(((_newWidth / 2) - (this.BetButtonXpos.allInButtonX * _newScale)) + (this.allinButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.allinButton.getHeight() * 0.5));
  ...
  ResizeCheckButton(_newWidth, _newHeight, _newScale) {
    ...
    this.checkButton.setPosition(((_newWidth / 2) - (this.BetButtonXpos.checkButtonX * _newScale)) + (this.checkButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.checkButton.getHeight() * 0.5));
  ...
  ResizeRaiseButton(_newWidth, _newHeight, _newScale) {
    ...
    this.raiseButton.setPosition(((_newWidth / 2) + (136 * _newScale)) + (this.raiseButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.raiseButton.getHeight() * 0.5));
  ...
  CreateRaiseSlider() {
    ...
    this.raiseSliderBase = this.scene.add.image(this.raiseSliderConstantValueObj.basePosX, this.raiseSliderConstantValueObj.basePosY + 3, 'raise_base').setOrigin(0);
    this.raiseSliderBar = this.scene.add.image(this.raiseSliderConstantValueObj.basePosX, this.raiseSliderConstantValueObj.basePosY + 3, 'raise_bar').setOrigin(0);
    this.raiseSliderChip = this.scene.add.image(this.raiseSliderConstantValueObj.basePosX - 2.5, this.raiseSliderConstantValueObj.basePosY + 8, 'poker_chip').setOrigin(0.5).setScale(1.3);
    this.raiseSliderBar.setCrop(0, 0, 0, this.raiseSliderBase.height);
    this.raiseSliderKnob = this.scene.add.image(this.raiseSliderConstantValueObj.barPosX + 8, this.raiseSliderConstantValueObj.barPosY + 12, 'raise_slider').setOrigin(0);
    this.raiseSliderKnob.setInteractive({ draggable: true });
    this.raiseSliderKnob.setData('name', 'RaiseSlider');

    const raiseAmountTextStyle = { fontFamily: 'Poppins-Regular', fontSize: '20px', fill: '#FFF3F2', fontStyle: 'normal', align: 'center' };
    ...
    this.raiseSliderKnobBase = this.scene.add.image(this.raiseAmountText.x, this.raiseAmountText.y + 5, 'raise_slider_base');
    ...
    this.scene.input.on('drag', (pointer, _gameObject, _dragX) => {
      if (_gameObject.getData('name') === 'RaiseSlider') {
        ...
        // this.raiseAmountText.setText(`$ ${parseInt(raiseAmountText + this.minVal)}`);
        this.raiseAmountText.setText(`$ ${raiseAmountText}`);
  ...
  HideRaiseSlider() {
    ...
    this.raiseSliderKnob.setPosition(this.raiseSliderConstantValueObj.barPosX + 8, this.raiseSliderConstantValueObj.barPosY + 12);
    ...
    this.raiseSliderKnobBase.setPosition(this.raiseAmountText.x, this.raiseAmountText.y + 5);
    this.raiseSliderBar.setCrop(0, 0, 0, this.raiseSliderBase.height);
  ...
  ResizeRaiseSlider(_newWidth, _newHeight, _newScale) {
    ...
    this.raiseSliderOkButton.setPosition(((_newWidth / 2) + (507 * _newScale)) + (this.raiseSliderOkButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.raiseSliderOkButton.getHeight() * 0.5));
    ...
    this.raiseSliderCloseButton.setPosition(((_newWidth / 2) + (694 * _newScale)) + (this.raiseSliderCloseButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.raiseSliderCloseButton.getHeight() * 0.5));
  ...
  ResizeHalfPotButton(_newWidth, _newHeight, _newScale) {
    ...
    this.halfPotButton.setPosition(((_newWidth / 2) + (this.BetButtonXpos.halfPotButtonX * _newScale)) + (this.halfPotButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.halfPotButton.getHeight() * 0.5));
    ...
    this.checkHalfPotButton.setPosition(this.halfPotButton.x - (75 * _newScale), this.halfPotButton.y);
  };
  ...
  ResizeThreeFourthPotButton(_newWidth, _newHeight, _newScale) {
    ...
    this.threeFourthPotButton.setPosition(((_newWidth / 2) + (this.BetButtonXpos.threeFourthButtonX * _newScale)) + (this.threeFourthPotButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.threeFourthPotButton.getHeight() * 0.5));
    ...
    this.checkThreeFourthPotButton.setPosition(this.threeFourthPotButton.x - (75 * _newScale), this.threeFourthPotButton.y);
  };
  ...
  ResizePotButton(_newWidth, _newHeight, _newScale) {
    ...
    this.potButton.setPosition(((_newWidth / 2) + (this.BetButtonXpos.potButtonX * _newScale)) + (this.potButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.potButton.getHeight() * 0.5));
    ...
    this.checkPotButton.setPosition(this.potButton.x - (75 * _newScale), this.potButton.y);
  };
  ...
  ResizeRaisedAllInButton(_newWidth, _newHeight, _newScale) {
    ...
    this.raisedAllInButton.setPosition(((_newWidth / 2) + (this.BetButtonXpos.raiseAllInButton * _newScale)) + (this.raisedAllInButton.getWidth() * 0.5), (_newHeight - (88 * _newScale)) - (this.raisedAllInButton.getHeight() * 0.5));
    ...
    this.checkRaisedAllInButton.setPosition(this.raisedAllInButton.x - (75 * _newScale), this.raisedAllInButton.y);
  };
  ...
  RaiseBarTweenControl(_endPosX, _targetAmt) {
    ...
    this.scene.add.tween({
      ...
      callbackScope: this,
      onUpdate: () => {
        this.raiseAmountText.x = this.raiseSliderKnob.x + 10;
        this.raiseSliderKnobBase.x = this.raiseAmountText.x;
      }
    });
    ...
    this.scene.tweens.add({
      ...
      ease: 'Linear',
      onUpdate: (tween, target) => {
        this.raiseSliderBar.setCrop(0, 0, target.value + 10, this.raiseSliderBase.height);
