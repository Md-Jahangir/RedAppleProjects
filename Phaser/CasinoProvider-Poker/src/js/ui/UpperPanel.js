...
class UpperPanel {
  ...
  CreateSitOutButton() {
    ...
    // console.log('crae: seatIndex: ', seatIndex);

    // if (seatIndex === null) {
    // this.EnableDisableSitOutButton(false);
    // }
  }
  OnSitOutButtonClicked() {
    // const seatIndex = Model.GetSeatIndex();
    // console.log('clicked: seatIndex: ', seatIndex);
  ...
  // EnableDisableSitOutButton(_status) {
  //   console.log('EnableDisableSitOutButton _status: ', _status);

  //   if (_status) {
  //     this.waitingSitButton.enable(_status);
  //   } else {
  //     this.waitingSitButton.disable(_status);
  //   }
  // }
  //#endregion
  //#################################################################
