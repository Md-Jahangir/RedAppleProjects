...
export default class RotateScreen {
    ...
    checkOrientation() {
        console.log('this.game.config.width', this.game.config.width, this.game.config.height, window.innerWidth, window.innerHeight);
        ...
        // this.ApplyOrientation(isPortrait);
