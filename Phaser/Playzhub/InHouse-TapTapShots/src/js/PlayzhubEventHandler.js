...
import { Server } from '../js/class/Server';
...
class PlayzhubEventHandler {
    ...
    constructor() {
        this.gameType = 'HTML5';
        this.gameName = "TapTapShots";
        console.log('Version PlayzHubSdk 1.0.0');
    ...
    GameStateUpdate(_starData, _score, _gameOptions) {
        let data;
        if (_starData != null) {
            data = {
                'starsData': _starData,
    ...
    //#region This will be called by the game to Ad show
    RequestAD() {
