...
export default class BasketBall {
    ...
    create() {
        ...
        this.newWidth = Constant.clientWidth;
        this.newHeight = Constant.clientHeight;
        ...
        this.velocityX = Math.round(12 * this.newScale);
        // this.velocityY = -Math.round(this.newHeight / 50);
        this.velocityY = -Math.round(38.4 * this.newScale);
        ...
        console.log('ball', this.ball.body);
    ...
    //#region - Ball on Click Functionality Handle
    BallControl() {
    ...
    //#region - Ball Direction Control When Basket is change
    ...
    resize(newWidth, newHeight, newScale) {
        ...
        this.ballShadow.y = newHeight - (166 * newScale);
