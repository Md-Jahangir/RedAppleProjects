...
class BottomPanel {
  ...
  OnRaiseSliderOkButtonClicked() {
    ...
    // console.log('this.scene.currentBet', this.scene.currentBet);
  ...
  IsSelectHalfPotButton(_isCheck) {
    if (_isCheck) {
      ...
      // this.scene.TempDebug(this.currentHalfPotAmount);
  ...
  IsSelectThreeFourthPotButton(_isCheck) {
    if (_isCheck) {
      ...
      // this.scene.TempDebug(this.currentThreeFourthPotAmount);
  ...
  IsSelectPotButton(_isCheck) {
    if (_isCheck) {
      ...
      // this.scene.TempDebug(this.currentRaisePotAmount);
  ...
  IsSelectRaisedAllInButton(_isCheck) {
    if (_isCheck) {
      ...
      // this.scene.TempDebug(this.currentRaiseAllInAmount);
