...
class Player {
  constructor(_scene, _posX, _posY) {
    ...
    this.frontCardPosArray = [{ x: -45, y: -120, angle: -20 }, { x: 55, y: -120, angle: 20 }];
    this.frontCardArray = [];
  ...
  CreateBackCardSection() {
    this.userBackCard1 = this.scene.add.sprite(this.userBase.x - 25, this.userBase.y - 95, 'front_card_0').setOrigin(0.5);
    this.userBackCard1.setAngle(340);
    // this.userBackCard1.setAngle(360);
    this.userBackCard1.setFrame(52);
    this.userBackCard2 = this.scene.add.sprite(this.userBase.x + 25, this.userBase.y - 95, 'front_card_0').setOrigin(0.5);
    this.userBackCard2.setAngle(20);
    // this.userBackCard2.setAngle(0);
    this.userBackCard2.setFrame(52);

    // this.userBackCard1 = this.scene.add.sprite(this.userBase.x - 20, this.userBase.y - 70, 'left_back_card_0').setOrigin(0.5);
    // this.userBackCard2 = this.scene.add.sprite(this.userBase.x + 20, this.userBase.y - 70, 'right_back_card_0').setOrigin(0.5);
  ...
  CreateFrontCardSection() {
    // for (let i = 0; i < 2; i++) {
    for (let i = 1; i >= 0; i--) {
      const card = this.scene.add.sprite(this.frontCardPosArray[i].x, this.frontCardPosArray[i].y, 'front_card_0').setOrigin(0.5).setScale(1.2);
