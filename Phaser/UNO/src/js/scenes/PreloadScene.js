...
export default class PreloadScene extends Phaser.Scene {
  ...
  LoadAssests() {
    ...
    this.load.spritesheet('change_color', 'assets/images/change_color.png', { frameWidth: 328, frameHeight: 315 });
    this.load.spritesheet('finger', 'assets/images/finger.png', { frameWidth: 202, frameHeight: 277 });
    this.load.spritesheet('draw_4', 'assets/images/draw_4.png', { frameWidth: 292, frameHeight: 290 });
    this.load.spritesheet('draw_2', 'assets/images/draw_2.png', { frameWidth: 292, frameHeight: 322 });
    this.load.spritesheet('cloud', 'assets/images/cloud.png', { frameWidth: 261, frameHeight: 194 });
    this.load.image('skip_turn', 'assets/images/skip_turn.png');
    this.load.image('change_clockwise', 'assets/images/change_clockwise.png');
    this.load.image('select_color_panel', 'assets/images/select_color_panel.png');
