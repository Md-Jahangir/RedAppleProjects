...
class AlertPopup {
  ...
  CreateBaseAndText() {
    ...
    const headingTextStyle = { fontFamily: 'Poppins-Regular', fontSize: '32px', fill: '#fff', fontStyle: 'bold', align: 'center', wordWrap: { width: this.base.width - 30 } };
    this.HeadingText = this.scene.add.text(this.base.x, this.base.y - 110, 'Alert !', headingTextStyle).setOrigin(0.5);
    const messageTextStyle = { fontFamily: 'Poppins-Regular', fontSize: '28px', fill: '#fff', fontStyle: 'bold', align: 'center', wordWrap: { width: this.base.width - 30 } };
    this.messageText = this.scene.add.text(this.base.x, this.base.y + 35, 'Yes get error now go to game please', messageTextStyle).setOrigin(0.5);
