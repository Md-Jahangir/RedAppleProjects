...
class Client {
  ...
  constructor() {
    ...
    this.baseUrl = 'https://poker.abstracodes.com/pokerCoreEngine';//stagging local machine;
    // this.baseUrl = 'http://192.168.1.61:5030/pokerCoreEngine';//stagging local machine
