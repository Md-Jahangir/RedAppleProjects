...
class Symbol {
    ...
    create(x, y) {
        this.usualImg = this.scene.add.image(x, y, "symbol_" + this.id).setOrigin(0.5, 0).setScale(Constant.scaleFactorX, Constant.scaleFactorY);
        this.spinAnim = this.scene.add.sprite(x, y, "symbol_spin_animation").setOrigin(0.5, 0).setScale(Constant.scaleFactorX, Constant.scaleFactorY);
