...
class QuitPopup {
    ...
    CreateQuitPopup() {
        ...
        let quitTextStyle = { fontFamily: 'Poppins_Bold', fontSize: '56px', fill: '#fff', fontStyle: 'bold', align: 'center' };
        ...
        this.yesButton = Utils.SpriteSettingsControl(this.scene, Math.round(game.config.width / 3.27), Math.round(game.config.height / 1.72), "yes_button", 0.5, 0.5, scaleFactor, scaleFactor, "true", this.YesButtonPressed, this.YesButtonReleased);

        this.noButton = Utils.SpriteSettingsControl(this.scene, Math.round(game.config.width / 1.44), Math.round(game.config.height / 1.72), "no_button", 0.5, 0.5, scaleFactor, scaleFactor, "true", this.NoButtonPressed, this.NoButtonReleased);
    ...
    NoButtonReleased() {
        ...
        this.scene.scene.StartMovement();
    }
