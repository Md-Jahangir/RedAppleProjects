class GameOverPopup {
    ...
    CreateGameOverPopup(_score) {
        ...
        var yourScoreTextStyle = { fontFamily: 'AmericanCaptain', fontSize: '70px', fill: '#fff', fontStyle: 'bold', align: 'left' };
        ...
        var replayTextStyle = { fontFamily: 'AmericanCaptain', fontSize: '50px', fill: '#001754', fontStyle: 'bold', align: 'center' };
        ...
        var menuTextStyle = { fontFamily: 'AmericanCaptain', fontSize: '50px', fill: '#001754', fontStyle: 'bold', align: 'center' };
