export default class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.title = Utils.SpriteSettingsControl(this, Math.round(game.config.width / 2), -Math.round(game.config.height / 3.2), "title", 0.5, 0.5, scaleFactor, scaleFactor);
        ...
        // this.playButtonContainer.alpha = 0;
    ...
    ShowTitleAndButton() {
        this.tweens.add({
            targets: [this.title],
            y: Math.round(game.config.height / 3.2),
            ease: 'Bounce.Out',
            duration: 500,
            delay: 100,
            callbackScope: this,
