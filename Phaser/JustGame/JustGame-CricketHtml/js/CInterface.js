function CInterface() {
    ...
    this._init = function () {
        ...
        _pStartPosScore = { x: (CANVAS_WIDTH / 2), y: 60 };
        ...
        // _pStartPositionRun = { x: (CANVAS_WIDTH / 2) - 50, y: (CANVAS_HEIGHT / 2) - 632 };
        _pStartPositionRun = { x: _oScoreBoard.x - 50, y: _oScoreBoard.y - 22 };
        ...
        _oRunText.textAlign = "center";
        _oRunText.textBaseline = "alphabetic";
        s_oStage.addChild(_oRunText);

        // _pStartPositionScore = { x: (CANVAS_WIDTH / 2) - 50, y: (CANVAS_HEIGHT / 2) - 584 };
        _pStartPositionScore = { x: _oScoreBoard.x - 50, y: _oScoreBoard.y + 26 };
        // _oScoreText1 = new createjs.Text("0/", "25px " + TondoRG, "#ffffff");
        _oScoreText1 = new createjs.Text("0", "28px " + TondoRG, "#000000");
        ...
        // _pStartPositionBallForOverHeadingText = { x: (CANVAS_WIDTH / 2) + 50, y: (CANVAS_HEIGHT / 2) - 632 };
        _pStartPositionBallForOverHeadingText = { x: _oScoreBoard.x + 50, y: _oScoreBoard.y - 22 };
        ...
        // _pStartPositionBallForOverText = { x: (CANVAS_WIDTH / 2) + 50, y: (CANVAS_HEIGHT / 2) - 584 };
        _pStartPositionBallForOverText = { x: _oScoreBoard.x + 50, y: _oScoreBoard.y + 26 };
        _overText = new createjs.Text(_OVER_TEXT, "28px " + TondoRG, "#000000");
        _overText.x = _pStartPositionBallForOverText.x;
        _overText.y = _pStartPositionBallForOverText.y;
        _overText.textAlign = "center";
        _overText.textBaseline = "alphabetic";
        s_oStage.addChild(_overText);

        var oSpriteBack = s_oSpriteLibrary.getSprite("back_icon");
        _pStartPosBackButton = { x: (CANVAS_WIDTH / 2) - 300, y: 60 };
        _oBackButton = new CGfxButton(_pStartPosBackButton.x, _pStartPosBackButton.y, oSpriteBack, s_oStage);
        _oBackButton.addEventListener(ON_MOUSE_DOWN, this.onBackButtonPressed, this);
        _oBackButton.regX = oSpriteBack.width * 0.5;
        _oBackButton.regY = oSpriteBack.height * 0.5;

        if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
            var oSprite = s_oSpriteLibrary.getSprite('audio_icon');
            _pStartPosAudio = { x: (CANVAS_WIDTH / 2) + 300, y: 60 };
    ...
    this.refreshButtonPos = function (iNewX, iNewY) {
        ...
        _oRunText.x = _pStartPositionRun.x + iNewX;
        _oScoreText1.x = _pStartPositionScore.x + iNewX;
        _overHeadingText.x = _pStartPositionBallForOverHeadingText.x + iNewX;
        _overText.x = _pStartPositionBallForOverText.x + iNewX;
        // _oBallText1.x = _pStartPositionBallText.x + iNewX;
        _oBackButton = _pStartPosBackButton.x + iNewX;
        _oBackButton = _pStartPosBackButton.y + iNewY;
    ...
    this.createHelpPanel = function () {
        ...
        _oHelpPanel = new CHelpPanel(0, 0);
    };
