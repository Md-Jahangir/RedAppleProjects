function CMenu() {
    ...
    this._init = function() {
        ...
        // menuBgYourScoreText = new createjs.Text("Your Run", "24px Tondo_Std_Rg", "#000000");
        ...
        // var reward1Text = new createjs.Text("Score " + scoreForReward1 + " more to unlock\n" + currentGiftVoucherForReward1 + "/" + remainingGiftVoucherForReward1 + " left", "24px Tondo_Std_Rg", "#ffffff");
        ...
        // reward1ClaimRectText.x = CANVAS_WIDTH / 2 - 269;
        // reward1ClaimRectText.y = CANVAS_HEIGHT / 2 + 532;
        // // reward1ClaimRectText.textAlign = "center";
        // // reward1ClaimRectText.x = CANVAS_WIDTH / 2 - 232;
        ...
        // var reward2Text = new createjs.Text("Score " + scoreForReward2 + " more to unlock\n" + currentGiftVoucherForReward2 + "/" + remainingGiftVoucherForReward2 + "left", "24px Tondo_Std_Rg", "#ffffff");
        ...
        // reward2ClaimRect = this.CreateRect(CANVAS_WIDTH / 2 - 280, CANVAS_HEIGHT / 2 + 885, 100, 50, 10, 10, 10, 10, '#ffffff', 1);
        ...
        // reward2ClaimRectText.x = CANVAS_WIDTH / 2 - 269;
        // reward2ClaimRectText.y = CANVAS_HEIGHT / 2 + 897;
        ...
        // var reward3Text = new createjs.Text("Score " + scoreForReward3 + " more to unlock\n" + currentGiftVoucherForReward3 + "/" + remainingGiftVoucherForReward3 + " left", "24px Tondo_Std_Rg", "#ffffff");
        ...
        // reward3ClaimRect = this.CreateRect(CANVAS_WIDTH / 2 - 280, CANVAS_HEIGHT / 2 + 1250, 100, 50, 10, 10, 10, 10, '#ffffff', 1);
        ...
        // reward3ClaimRectText.x = CANVAS_WIDTH / 2 - 269;
        ...
        // var reward4Text = new createjs.Text("Score " + scoreForReward4 + " more to unlock\n" + currentGiftVoucherForReward4 + "/" + remainingGiftVoucherForReward4 + " left", "24px Tondo_Std_Rg", "#ffffff");
        ...
        // reward4ClaimRect = this.CreateRect(CANVAS_WIDTH / 2 - 280, CANVAS_HEIGHT / 2 + 1615, 100, 50, 10, 10, 10, 10, '#ffffff', 1);
        ...
        // reward4ClaimRectText.x = CANVAS_WIDTH / 2 - 269;
        // reward4ClaimRectText.y = CANVAS_HEIGHT / 2 + 1627;
        ...
        // var reward5Text = new createjs.Text("Top " + scoreForReward5 + " scorers\n" + currentGiftVoucherForReward5 + "/" + remainingGiftVoucherForReward5 + " left", "24px Tondo_Std_Rg", "#ffffff");
        ...
        // reward5ClaimRect = this.CreateRect(CANVAS_WIDTH / 2 - 280, CANVAS_HEIGHT / 2 + 1980, 100, 50, 10, 10, 10, 10, '#ffffff', 1);
        ...
        // reward5ClaimRectText.x = CANVAS_WIDTH / 2 - 269;
        // reward5ClaimRectText.y = CANVAS_HEIGHT / 2 + 1992;
        ...
        menuBg = createBitmap(s_oSpriteLibrary.getSprite('menu_bg'));
        menuBg.x = 0;
        menuBg.y = 0;
        menuContainer.addChild(menuBg);

        var oSprite = s_oSpriteLibrary.getSprite('cricket_logo');
        menuCricketLogo = createBitmap(oSprite);
        menuCricketLogo.x = CANVAS_WIDTH / 2;
        menuCricketLogo.y = CANVAS_HEIGHT / 4.2
        menuCricketLogo.regX = oSprite.width * 0.5;
        menuCricketLogo.regY = oSprite.height * 0.5;
        menuContainer.addChild(menuCricketLogo);

        var oSprite = s_oSpriteLibrary.getSprite('play_button');
        playButton = new CGfxButton((CANVAS_WIDTH / 2), CANVAS_HEIGHT / 1.2, oSprite, menuContainer);
        playButton.addEventListener(ON_MOUSE_UP, this._onPlayButtonRelease, this);


        // var oSprite = s_oSpriteLibrary.getSprite('play_button_base');
        // _oPlayButtonBase = new CGfxButton((CANVAS_WIDTH / 2), CANVAS_HEIGHT / 2 - 90, oSprite, menuContainer);
        ...
        // menuContainer.addChild(_oPlayButtonText);
        // if (isPlayed == 1) {
        ...
        s_oStage.addChild(menuContainer);
    ...
    //     window.location.href = "http://stg.airtelcricketbonanza.com/faqs.html?token=" + token + "&secret=" + secretKey;
    // };
