...
export default class PreloadScene extends Phaser.Scene 
{
    ...
    create() 
    {
        ...
        LoadAssets.LoadAssests(this,JSON.parse(localStorage.getItem("ItsLeftItsRightJsonData")),this.LoadComplete);
        // LoadAssets.LoadAssests(this,window.navigator.onLine,JSON.parse(localStorage.getItem("ItsLeftItsRightJsonData")),this.LoadComplete);
    }
