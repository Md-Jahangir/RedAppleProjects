...
class LoadAssets 
{
    ...
    LoaDataFromLocalStorage(_this,_loadAssetsRef,_callback)
    {
        ...
        let wholeJSon = JSON.parse(localStorage.getItem('ItsLeftItsRightJsonData'));
    ...
    {
        let wholeImageJSon =  JSON.parse(localStorage.getItem("ItsLeftItsRightImageData")) ;
        let wholeJSon = JSON.parse(localStorage.getItem("ItsLeftItsRightJsonData"));
        let bgImageLocatins;
    ...
    LoadCommonItems(_this)
    {
        ...
        _this.load.image('left_button', 'assets/images/left_button.png');
        _this.load.image('right_button', 'assets/images/right_button.png');
