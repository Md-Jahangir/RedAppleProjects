...
class Database {
    ...
    StoreImageData(_this, _db)//===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================
        let wholeJSon = JSON.parse(localStorage.getItem("ItsLeftItsRightImageData"));//_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("ItsLeftItsRightJsonData"));//_this.cache.json.get('jsonData');
        // console.log("wholeJSon",wholeJSon);
