...
export default class BootScene extends Phaser.Scene {
    ...
    async onDataRecieved(_this) {
        if (Server.platform && Server.platform == "favorites") {
            ...
            if (data.error == 0) {
                ...
                localStorage.setItem("ItsLeftItsRightJsonData", JSON.stringify(data.data));
        ...
        if (Server.platform && Server.platform == "favorites") {
            ...
            if (data.error == 0 && (bgImages.length !== 0) && (mainImages.length !== 0)) {
                ...
                if (bgImages == "") {
                    ...
                    this.errorPopup.ShowErrorPopup("Not Enough main image is available");
                }
                return false;
            }
        } else {
    ...
    ImageData(_data) {
        localStorage.setItem("ItsLeftItsRightImageData", JSON.stringify(_data.data));
    }
    create() {
        ...
        if (checkFirstTime) {
            ...
            if (this.CheckInternetConnection())/*internet is connected*/ {
                ...
                let _data = JSON.parse(localStorage.getItem("ItsLeftItsRightJsonData"));
