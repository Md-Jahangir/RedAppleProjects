class ErrorPopup {
    ...
    CreateErrorPopup() {
        ...
        let popupBg = this.scene.add.sprite(0, 0, "popupBg").setOrigin(0.5, 0.5).setScale(scaleFactor);
        let errorText = this.scene.add.text(0, 0,  "", errorTextStyle).setOrigin(0.5).setScale(scaleFactorX*2,scaleFactorY*2);
        
        // this.loadingPopupContainer.add(this.overlay);
        this.errorPopupContainer.add(popupBg);
        this.errorPopupContainer.add(errorText);
