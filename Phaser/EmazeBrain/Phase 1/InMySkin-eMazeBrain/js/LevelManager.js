...
class LevelManager {
    constructor() {
        ...
        this.totalBackgroundImage = null;
    ...
    InitializeLevel(_arr) {
        ...
        // this.movementType = 0;// Database.GetGeneralData("movement_type");
        this.DecideAnswerAndDestractors();
    }
    DecideLevelBackground()//==> random background <===//
    {
        return this.totalBackgroundImage;//[0];
    ...
    LevelDataUpdate(_arr) {
        // console.log("LevelDataUpdate ",_arr);
        this.levelNumber = this.initialLevelNumber = _arr[0];
        this.movementDirection = _arr[1];
        this.movementTime = _arr[2];
        this.totalNumberOfGame = _arr[3];
        this.movementType = _arr[4];
        this.maxTimeForGame = _arr[5];
        this.maxTimeForLevel = _arr[6];
    };
    getRandom(arr, n) {
    ...
    DecideTimeOrNumberOfQuestion() {
        ...
        // let response = this.totalNumberOfGame;
