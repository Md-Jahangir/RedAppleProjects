...
class Database {
    ...
    {
        console.log('specific _data', _data);
    ...
    StoreImageData(_this, _db)//===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================
        let wholeJSon = JSON.parse(localStorage.getItem("you'reTheTherapistImageJson"));//_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("you'reTheTherapistJsonData"));//_this.cache.json.get('jsonData');
