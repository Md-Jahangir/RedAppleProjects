...
export default class PreloadScene extends Phaser.Scene 
{
    ...
    preload() 
    {
       this.load.image('angry_1','assets/images/angry_1.png');
    }
    create() 
    {
        ...
        LoadAssets.LoadAssests(this,JSON.parse(localStorage.getItem("you'reTheTherapistImageJson")),this.LoadComplete);
        // LoadAssets.LoadAssests(this,window.navigator.onLine,JSON.parse(localStorage.getItem("you'reTheTherapistImageJson")),this.LoadComplete);
    }
