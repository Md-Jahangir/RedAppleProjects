...
class LoadAssets 
{
    ...
    {
        let wholeImageJSon =  JSON.parse(localStorage.getItem("moreislessimageJson")) ;
        let wholeJSon = JSON.parse(localStorage.getItem("moreislessjsonData"));
        let bgImageLocatins;
        ...
        let normalImages = [];
        if(normalImageLocations.length > 23)
        {
            normalImages =  LevelManager.getRandom(normalImageLocations,23);
        }
        else
        {
