...
class Database {
    ...
    ParseAndStore(_json) {
        ...
        console.log('this.average_answer_time : ', this.average_answer_time);
    ...
    StoreImageData(_this, _db)//===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================
        let wholeJSon = JSON.parse(localStorage.getItem("moreislessimageJson"));//_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("moreislessjsonData"));//_this.cache.json.get('jsonData');
