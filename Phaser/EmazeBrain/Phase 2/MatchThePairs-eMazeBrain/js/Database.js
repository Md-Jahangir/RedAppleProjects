...
class Database {
    ...
    StoreImageData(_this, _db)//===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================//
        let wholeJSon = JSON.parse(localStorage.getItem("MatchThePairsImageJson"));//_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("MatchThePairsJsonData"));//_this.cache.json.get('jsonData');
