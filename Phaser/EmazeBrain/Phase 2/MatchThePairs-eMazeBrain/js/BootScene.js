...
export default class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('thumb_bg', 'assets/images/thumb_bg.png');
    ...
    async onDataRecieved(_this) {
        if (Server.platform && Server.platform == "favorites") {
            ...
            if (data.error == 0) {
                ...
                localStorage.setItem("MatchThePairsJsonData", JSON.stringify(data.data));
        ...
        if (Server.platform && Server.platform == "favorites") {
            ...
            if (data.error == 0 && (bgImages.length !== 0) && (mainImages.length !== 0)) {
                ...
                if (bgImages == "") {
                    ...
                    console.log('main image is null');
    ...
    ImageData(_data) {
        localStorage.setItem("MatchThePairsImageJson", JSON.stringify(_data.data));
    }
    create() {
        ...
        if (checkFirstTime) {
            ...
            if (this.CheckInternetConnection())/*internet is connected*/ {
                ...
                let _data = JSON.parse(localStorage.getItem("MatchThePairsJsonData"));
