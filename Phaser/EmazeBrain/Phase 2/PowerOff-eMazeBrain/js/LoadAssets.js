...
class LoadAssets {
    ...
    LoaDataFromLocalStorage(_this, _loadAssetsRef, _callback) {
        ...
        let wholeJSon = JSON.parse(localStorage.getItem('moreislessimageJson'));
    ...
    LoadDataFromUrl(_LoadAssets, _this) {
        ...
        let wholeImageJSon = JSON.parse(localStorage.getItem("poweroffimagejson")); //_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("poweroffjsonData")); //_this.cache.json.get('jsonData');
        let bgImageLocatins;
        ...
        let normalImages = [];
        if (normalImageLocations.length > 10) {
            normalImages = LevelManager.getRandom(normalImageLocations, 10);
        }
        else {
        ...
        // let wholeImageJSon =  JSON.parse(localStorage.getItem("poweroffimageJson"));
        // let wholeJSon = JSON.parse(localStorage.getItem("poweroffjsonData"));
        // let bgImageLocatins;
        // let normalImageLocations = [];
        // let image_name;
    ...
    LoadCommonItems(_this) {
        ...
        _this.load.image('grey', 'assets/images/grey.png');
        _this.load.image('like', 'assets/images/like.png');
        _this.load.image('unlke', 'assets/images/unlke.png');
        ...
        _this.load.audio('tone_131', 'assets/Sounds/click/tone_131.wav');
        _this.load.audio('tone_146', 'assets/Sounds/click/tone_146.wav');
        _this.load.audio('tone_164', 'assets/Sounds/click/tone_164.wav');
        _this.load.audio('tone_174', 'assets/Sounds/click/tone_174.wav');
        _this.load.audio('tone_195', 'assets/Sounds/click/tone_195.wav');
        _this.load.audio('tone_220', 'assets/Sounds/click/tone_220.wav');
        _this.load.audio('tone_246', 'assets/Sounds/click/tone_246.wav');
        _this.load.audio('tone_261', 'assets/Sounds/click/tone_261.wav');
        _this.load.audio('tone_294', 'assets/Sounds/click/tone_294.wav');
        _this.load.audio('tone_330', 'assets/Sounds/click/tone_330.wav');
        _this.load.audio('tone_350', 'assets/Sounds/click/tone_350.wav');
        _this.load.audio('tone_392', 'assets/Sounds/click/tone_392.wav');
        _this.load.audio('tone_440', 'assets/Sounds/click/tone_440.wav');
        _this.load.audio('tone_494', 'assets/Sounds/click/tone_494.wav');
