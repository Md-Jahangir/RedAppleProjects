...
class Database {
    ...
    ParseAndStore(_json) {
        ...
        console.log('this.bg_image_location : ', this.bg_image_location);
    ...
    StoreImageData(_this, _db) //===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================
        let wholeJSon = JSON.parse(localStorage.getItem("poweroffimagejson")); //_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("poweroffimagejson")); //_this.cache.json.get('jsonData');
        console.log('gameJSon', wholeJSon);
