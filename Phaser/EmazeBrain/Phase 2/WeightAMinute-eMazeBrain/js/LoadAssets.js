...
class LoadAssets 
{
    ...
    {
        let wholeImageJSon =  JSON.parse(localStorage.getItem("WeightAMinuteImageJson")) ;
        let wholeJSon = JSON.parse(localStorage.getItem("WeightAMinuteJsonData"));
        let bgImageLocatins;
        ...
        let normalImages = [];
        if(normalImageLocations.length > 13)
        {
            normalImages =  LevelManager.getRandom(normalImageLocations,13);
        }
        else
        {
