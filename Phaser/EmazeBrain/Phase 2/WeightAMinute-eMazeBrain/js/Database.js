...
class Database {
    ...
    ParseAndStore(_json) {
        let jsonData = _json;
        console.log(' json obj  : ', jsonData)
        this.lastHighestScore = jsonData.lastHighestScore;
        console.log('last highest score : ', this.lastHighestScore);
        //==========Storing JSON DATA ================//
    ...
    GeneralDataStore(_data)//=======>  Storing General data  <==============//
    {
        ...
        console.log('this.answer_location : ', this.answer_location)
        ...
        // console.log('this.main_image_location : ', this.main_image_location);
    };
    ...
    StoreImageData(_this, _db)//===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================
        let wholeJSon = JSON.parse(localStorage.getItem("WeightAMinuteImageJson"));//_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("WeightAMinuteJsonData"));//_this.cache.json.get('jsonData');
