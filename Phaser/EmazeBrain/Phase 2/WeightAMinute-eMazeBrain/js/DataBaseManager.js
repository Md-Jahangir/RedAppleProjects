...
//             _this.store = _this.db.createObjectStore('FindUsIfYouCanImageData', {
//                 autoIncrement: true
//             });
...
//         const txn = _this.db.transaction('FindUsIfYouCanImageData', 'readwrite');

//         // get the ImageData object store
//         const store = txn.objectStore('FindUsIfYouCanImageData');
//         //
...
//     {
//         const txn = _this.db.transaction('FindUsIfYouCanImageData', 'readonly');
//         const store = txn.objectStore('FindUsIfYouCanImageData');
...
//             _this.db = event.target.result;
//             const txn = _this.db.transaction('FindUsIfYouCanImageData', "readonly");
//             const objectStore = txn.objectStore('FindUsIfYouCanImageData');            
...
//             _DataBaseManager.store = _DataBaseManager.db.createObjectStore('FindUsIfYouCanImageData', {
//                 autoIncrement: true
//             });
...
//         _this.request.onsuccess = (event) => {
//             _this.db = event.target.result;
//             if( _this.db.objectStoreNames.contains("FindUsIfYouCanImageData"))
//             {
//                 const txn = _this.db.transaction('FindUsIfYouCanImageData', "readwrite");
//                 const objectStore = txn.objectStore('FindUsIfYouCanImageData');  
