...
class LoadAssets {
    ...
    LoaDataFromLocalStorage(_this, _loadAssetsRef, _callback) {
        ...
        let wholeJSon = JSON.parse(localStorage.getItem('NeonCalculatorImageJson'));
    ...
    LoadDataFromUrl(_LoadAssets, _this) {
        let wholeImageJSon = JSON.parse(localStorage.getItem("NeonCalculatorImageJson"));
        let wholeJSon = JSON.parse(localStorage.getItem("NeonCalculatorJsonData"));
        let bgImageLocatins;
        ...
        LevelManager.TotalBackgroundImage = singleImage[0];//"Back" + singleImage;
    ...
    LoadCommonItems(_this) {
        _this.load.image('unlike', 'assets/images/unlike.png');
        _this.load.image('like', 'assets/images/like.png');
        _this.load.image('base', 'assets/images/base.png');
        for (let i = 0; i <= 9; i++) {
            _this.load.image('number_' + i, 'assets/images/numbers/' + i + '.png');
        }
        _this.load.image('equal', 'assets/images/signs/equal.png');
        _this.load.image('greater', 'assets/images/signs/greater.png');
        _this.load.image('less', 'assets/images/signs/less.png');
        _this.load.image('cross', 'assets/images/signs/cross.png');
