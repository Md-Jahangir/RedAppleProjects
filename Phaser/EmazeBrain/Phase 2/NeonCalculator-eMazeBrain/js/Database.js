...
class Database {
    ...
    {
        this.auto_correct = 0;//_data.auto_correct;
    ...
    StoreImageData(_this, _db)//===> Storing Image JSON data <====================//
    {
        let location, i, j;
        //========================
        let wholeJSon = JSON.parse(localStorage.getItem("NeonCalculatorImageJson"));//_this.cache.json.get('imageJson');
        let gameJSon = JSON.parse(localStorage.getItem("NeonCalculatorJsonData"));//_this.cache.json.get('jsonData');
        ...
        console.log('GameArchitechture : ', GameArchitechture);
        //==============cool=================================//
