...
class LoadAssets 
{
    ...
    LoaDataFromLocalStorage(_this,_loadAssetsRef,_callback)
    {
        ...
        let wholeJSon = JSON.parse(localStorage.getItem('followthemoskovaimageJson'));
    ...
    {
        console.log('_LoadAssets'+_LoadAssets);
        let wholeImageJSon =  JSON.parse(localStorage.getItem("followthemoskovaimageJson"));
        console.log('wholejson',wholeImageJSon)
        let wholeJSon = JSON.parse(localStorage.getItem("followthemoskovajsonData"));
        let bgImageLocatins;
        ...
        // console.log('_this',normalImageLocations)
        ...
        let normalImages = [];
        if(normalImageLocations.length > 40)
        {
            normalImages =  LevelManager.getRandom(normalImageLocations,40);
        }
        else
        {
