function CMain(oData) {
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("but_close", "./sprites/but_close.png");
        s_oSpriteLibrary.addSprite("audio_icon", "./sprites/audio_icon.png");
        s_oSpriteLibrary.addSprite("but_info", "./sprites/but_info.png");
        s_oSpriteLibrary.addSprite("money_base", "./sprites/money_base.png");
        s_oSpriteLibrary.addSprite("chips_base", "./sprites/chips_base.png");
        ...
        s_oSpriteLibrary.addSprite("popup_base", "./sprites/popup/popup_base.png");
        s_oSpriteLibrary.addSprite("but_yes", "./sprites/popup/but_yes.png");
        s_oSpriteLibrary.addSprite("but_no", "./sprites/popup/but_no.png");
        s_oSpriteLibrary.addSprite("but_rechange", "./sprites/popup/but_rechange.png");
        s_oSpriteLibrary.addSprite("but_menu_play", "./sprites/but_menu_play.png");
        s_oSpriteLibrary.addSprite("info_popup_base", "./sprites/popup/info_popup_base.png");


        s_oSpriteLibrary.addSprite("bg_menu", "./sprites/bg_splash.png");
        // s_oSpriteLibrary.addSprite("but_play_base", "./sprites/but_play_base.png");
        // s_oSpriteLibrary.addSprite("craps_logo_big", "./sprites/craps_logo_big.png");
        ...
        // s_oSpriteLibrary.addSprite("settings_panel_bg", "./sprites/settings_panel_bg.png");
        ...
        // s_oSpriteLibrary.addSprite("dices_screen_bg", "./sprites/dices_screen_bg.png");
        s_oSpriteLibrary.addSprite("dices_screen_bg_come", "./sprites/dices_screen_bg_come.png");
        // s_oSpriteLibrary.addSprite("gameplay_board", "./sprites/gameplay_board.png");
        // s_oSpriteLibrary.addSprite("casino_logo", "./sprites/casino_logo.png");
        s_oSpriteLibrary.addSprite("msg_box", "./sprites/dices_box.png");
        ...
        //Enlight(When hover image showing)
        ...
        for (var i = 0; i < NUM_FICHES; i++) {
            s_oSpriteLibrary.addSprite("fiche_new_" + i, "./sprites/fiche_new_" + i + ".png");
        }
...
//written by me for theme
var s_bIsLightTheme = false;