function CMenu() {
    ...
    this._init = function () {
        ...
        //Play button
        var oSprite = s_oSpriteLibrary.getSprite('but_menu_play');
        ...
        // _oButPlay = new CTextButton(_pStartPosPlay.x, _pStartPosPlay.y, oSprite, languageService.getString("TEXT_PLAY"), FONT_GEORGIA, "#000", 20, "center", s_oStage);
