function CGameSettings() {
    ...
    this._initAttachFiches = function () {
        ...
        _aAttachFiches["pass_line"] = { x: 410, y: 792 };
        _aAttachFiches["dont_pass1"] = { x: 1070, y: 712 };
        _aAttachFiches["dont_pass2"] = { x: 325, y: 440 };
        _aAttachFiches["dont_come"] = { x: 430, y: 315 };
        _aAttachFiches["come"] = { x: 490, y: 450 };
        _aAttachFiches["field"] = { x: 480, y: 590 };
        _aAttachFiches["big_6"] = { x: 345, y: 620 };
        _aAttachFiches["big_8"] = { x: 430, y: 700 };

        var aData = [{ value: 4, x: 585, y: 170 }, { value: 5, x: 715, y: 170 }, { value: 6, x: 845, y: 170 }, { value: 8, x: 975, y: 170 }, { value: 9, x: 1100, y: 170 }, { value: 10, x: 1230, y: 170 }];
        for (var i = 0; i < aData.length; i++) {
            _aAttachFiches["lay_bet" + aData[i].value] = { x: aData[i].x, y: aData[i].y };
            _aAttachFiches["lose_bet" + aData[i].value] = { x: aData[i].x - 58, y: aData[i].y + 30 };
            _aAttachFiches["number" + aData[i].value] = { x: aData[i].x - 22, y: aData[i].y + 100 };
            _aAttachFiches["win_bet" + aData[i].value] = { x: aData[i].x - 22, y: aData[i].y + 172 };
        }

        _aAttachFiches["any11_7"] = { x: 1503, y: 815 };
        _aAttachFiches["any_craps_7"] = { x: 1503, y: 877 };
        _aAttachFiches["seven_bet"] = { x: 1503, y: 515 };
        _aAttachFiches["hardway6"] = { x: 1400, y: 577 };
        _aAttachFiches["hardway10"] = { x: 1602, y: 577 };
        _aAttachFiches["hardway8"] = { x: 1400, y: 657 };
        _aAttachFiches["hardway4"] = { x: 1602, y: 657 };
        _aAttachFiches["horn3"] = { x: 1365, y: 737 };
        _aAttachFiches["horn2"] = { x: 1500, y: 737 };
        _aAttachFiches["horn12"] = { x: 1635, y: 737 };
    ...
    this.getBetWinLoss = function (iState, iNumberPoint, szBet) {
        ...
        if (serverRequests.mode == 'online') {
            return serverRequests.getBetWinLoss(iState, iNumberPoint, szBet);
        } else {
            return this.getBetWinLossOffline(iState, iNumberPoint, szBet);

        }

    };

    this.getBetWinLossOffline = function (iState, iNumberPoint, szBet) {
    ...
    this.checkBetWin = function (iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult) {
        var aRandDicesResp = serverRequests.checkBetWin(iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult);
        return aRandDicesResp.result;
    };

    this.checkBetWinOld = function (iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult) {
    ...
    this.checkBetWin = function (iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult) {
        ...
        if (serverRequests.mode == 'online') {
            return serverRequests.checkBetWin(iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult);
        } else {
            return this.checkBetWinOffline(iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult);

        }

    };

    this.checkBetWinOffline = function (iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult) {
