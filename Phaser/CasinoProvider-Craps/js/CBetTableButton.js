function CBetTableButton(iXPos, iYPos, oSprite, szName, oContainer) {
    ...
    this.buttonRelease = function() {
        ...
        if (_aCbCompleted[ON_MOUSE_UP]) {
            _aCbCompleted[ON_MOUSE_UP].call(_aCbOwner[ON_MOUSE_UP], { button: _szName }, false);
        }
    };

    this.buttonDown = function() {
        if (_aCbCompleted[ON_MOUSE_DOWN]) {
            _aCbCompleted[ON_MOUSE_DOWN].call(_aCbOwner[ON_MOUSE_DOWN], { button: _szName }, false);
        }
    };
