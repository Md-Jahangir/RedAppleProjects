...
class Model {
    constructor() {
        ...
        this.soundStatus;
        this.musicStatus;
        this.totalFreeSpinWinAmount = "0.00";
    };
    ...
    setBalance(_newBalance) {
        this.balance = parseFloat(_newBalance).toFixed(2);
    };
    ...
    GetBonusAmountForDeduct(_betAmount) {
        let amount;
        switch (_betAmount) {
            case "0.20":
                amount = 10;
    ...
    SetFreeSpinTotalWinAmount(_amount) {
        this.totalFreeSpinWinAmount = parseFloat(_amount).toFixed();
    };
    GetFreeSpinTotalWinAmount() {
        return parseFloat(this.totalFreeSpinWinAmount).toFixed(2);
    };
