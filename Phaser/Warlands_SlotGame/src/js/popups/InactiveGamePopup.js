...
class InactiveGamePopup {
    ...
    CreateInactiveGamePopup(_message) {
        this.inactiveGamePopupContainer = this.scene.add.container(Math.round(constant.game.config.width / 2), Math.round(constant.game.config.height / 2)).setScale(scaleFactorX, scaleFactorY);
