...
GamePlay.prototype = {
    ...
    create: function() {
        ...
        skyBackground = Utils.SpriteSettingsControl(skyBackground, 640, 80, 'skyblue', "true", "true", 0.5, 0.5, 1409, 170, "false");
        // skyBackground.tint = "0x0099ff";

        moon = Utils.SpriteSettingsControl(bottomBackground, 790, 127, 'moon', "true", "true", 0.5, 0.5, 0.8, 1, "false");

        falseWater = Utils.SpriteSettingsControl(falseWater, 600, 180, 'falseWater', "true", "true", 0.5, 0.5,2.4, 2.9, "false");

        water = Utils.SpriteSettingsControl(water, 590, 115, 'water', "true", "true", 0.5, 0, 2.7, 0.75, "false");
        water.animations.add('waterAnimation');
        water.animations.play('waterAnimation', 8, true);

        bottomBackground = Utils.SpriteSettingsControl(bottomBackground, 611, 315, 'bottomBackground', "true", "true", 0.5, 0, 1.6, 1, "false");

        printingText = game.add.text(565, 420, "", { font: '75px Arial', fill: '#990000', fontWeight: 'bold italic', align: 'center', });
        ...
        nameText = game.add.text(360, 45, "Enter your name :", nameTextstyle);
        nameText.anchor.setTo(0.5);
        nameTextFieldInput = game.add.inputField(250, 75, {
            font: '32px Arial',
            fill: '#000000',
            textAlign: 'center',
            fillAlpha: 1,
        ...
        writeButton = Utils.ButtonSettingsControl(writeButton, 790, 45, 'button_base', this.WriteBttnDown, this.WriteBttnOver, this.WriteBttnOut, this.WriteBttnUp, "true", "true", 0.5, 0.5, 1.2, 1.2, this);
        writeButtonText = game.add.text(752, 32, "WRITE", { font: '24px Arial', fill: '#990000', fontWeight: 'bold', align: 'center', });
        writeButton.input.useHandCursor = true;

        eraseButton = Utils.ButtonSettingsControl(eraseButton, 955, 45, 'button_base', this.EraseBttnDown, this.EraseBttnOver, this.EraseBttnOut, this.EraseBttnUp, "true", "true", 0.5, 0.5, 1.2, 1.2, this);
        eraseButtonText = game.add.text(915, 32, "ERASE", { font: '24px Arial', fill: '#990000', fontWeight: 'bold', align: 'center', });
        eraseButton.inputEnabled = false;

        boat = Utils.SpriteSettingsControl(boat, 290, 310, 'boat', "true", "true", 0.5, 0.5, -0.45, 0.45, "false");
        boat.animations.add('boatAnimation');
        boat.animations.play('boatAnimation', 10, true);

        boat2 = Utils.SpriteSettingsControl(boat2, 1005, 230, 'boat', "true", "true", 0.5, 0.5, 0.3, 0.3, "false");
        boat2.animations.add('boat2Animation');
        boat2.animations.play('boat2Animation', 10, true);
        boat2.visible = false;

        dolphin = Utils.SpriteSettingsControl(dolphin, 350, 150, 'dolphin', "true", "true", 0.5, 0.5, -0.8, 0.8, "false");
        dolphin.animations.add('dolphinAnimation');
        dolphin.visible = false;

        dolphin2 = Utils.SpriteSettingsControl(dolphin2, 900, 140, 'dolphin', "true", "true", 0.5, 0.5, 0.8, 0.8, "false");
    ...
    WaterTween: function() {
        ...
        var waterTween = game.add.tween(water.scale).to({ y: 0.89 }, 1500, "Linear", true);
