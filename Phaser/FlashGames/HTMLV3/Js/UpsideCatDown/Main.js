...
Main.prototype = {
    ...
    preload: function() {
        game.load.script('GamePlay', 'Js/UpsideCatDown/GamePlay.js');
    ...
    create: function() {
        ...
        loadingText = game.add.sprite(690, 220, 'lodingText');
        ...
        loadingBarFrame = Utils.SpriteSettingsControl(loadingBarFrame, 670, 270, 'loadBarFrame',"true", "true", 0.5, 0.5, 0.4, 0.25, this);
        loadingBarFill = Utils.SpriteSettingsControl(loadingBarFill, 380, 270, 'loadBarFill',"true", "true", 0, 0.5, 0.01, 0.15, this);
