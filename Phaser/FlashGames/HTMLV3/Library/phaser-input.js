        ...
        InputField.prototype.updateTextAlignment = function() {
            switch (this.inputOptions.textAlign) {
                case 'left':
                    ...
                    this.cursor.x = this.getCaretPosition(); //this.inputOptions.padding + 
                    break;
                case 'center':
                    ...
                    this.cursor.x = this.inputOptions.width / 2 - this.text.width / 2 + this.getCaretPosition(); //this.inputOptions.padding + 
                    break;
                case 'right':
                    ...
                    this.cursor.x = this.inputOptions.width; //this.inputOptions.padding +
                    break;
            }
        };
            ...
            if (this.domElement.hasSelection) {
                ...
                switch (this.inputOptions.textAlign) {
                    case 'left':
                        ...
                        break;
                    case 'center':
                        this.selection.x = this.inputOptions.width / 2 - this.text.width / 2; //this.inputOptions.padding +
                        break;
                }
            } else {
