function CAreYouSurePanel(oParentContainer) {
    ...
    this._init = function() {
        ...
        _oMsg = new createjs.Text(TEXT_ARE_SURE, "70px " + TondoRG, "#ffffff");
        ...
        _oButYes = new CGfxButton(CANVAS_WIDTH / 2 + 160, CANVAS_HEIGHT * 0.5 + 160, s_oSpriteLibrary.getSprite('but_yes'), _oContainer);
        _oButYes.addEventListener(ON_MOUSE_UP, this._onButYes, this);

        _oButNo = new CGfxButton(CANVAS_WIDTH / 2 - 160, CANVAS_HEIGHT * 0.5 + 160, s_oSpriteLibrary.getSprite('but_no'), _oContainer);
