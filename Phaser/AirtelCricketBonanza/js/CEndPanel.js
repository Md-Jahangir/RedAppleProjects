function CEndPanel(oSpriteBg) {
    ...
    this._init = function(oSpriteBg) {
        ...
        _oBg.x = CANVAS_WIDTH / 2 - 390;
        _oBg.scaleY = 1.4;

        _oBg.on("click", function() {});

        _oMsgText1 = new createjs.Text("", " 44px " + TondoRG, "#fff");
        ...
        _oScoreText1 = new createjs.Text("", " 40px " + TondoRG, "#fff");
        ...
        var oSpriteRestart = s_oSpriteLibrary.getSprite('but_restart2');
        _oButRestart = new CGfxButton(CANVAS_WIDTH / 2 + 170, CANVAS_HEIGHT_HALF + 160, oSpriteRestart, _oGroup);

        var oSpriteHome = s_oSpriteLibrary.getSprite('but_home2');
        _oButHome = new CGfxButton(CANVAS_WIDTH / 2 - 167, CANVAS_HEIGHT_HALF + 160, oSpriteHome, _oGroup);

        var oSpriteShare = s_oSpriteLibrary.getSprite('share_button2');
        _oButShare = new CGfxButton(CANVAS_WIDTH / 2 - 0, CANVAS_HEIGHT_HALF + 160, oSpriteShare, _oGroup);
    ...
    this._initListener = function() {
        ...
        _oButShare.addEventListener(ON_MOUSE_UP, this._onShareBUttonPressed, this);
    };
    ...
    this._onShareBUttonPressed = function() {
        this.unload();
        var oSharePanel = new CSharePanel(s_oStage);
        oSharePanel.show();
    };
