...
class BuyinPopup {
  ...
  CreateBaseAndHeadingText() {
    this.buyinPopupBase = this.scene.add.image(0, 7, 'buyin_popup_base');
    const buyinHeadingTextStyle = { fontFamily: 'Poppins-SemiBold', fontSize: '52px', fill: '#fff', fontStyle: 'bold', align: 'center', wordWrap: { width: this.buyinPopupBase.width - 20 } };
    this.buyinHeadingText = this.scene.add.text(this.buyinPopupBase.x, this.buyinPopupBase.y - 420, 'Buy-In', buyinHeadingTextStyle).setOrigin(0.5);
  ...
  CreateGameTypeText() {
    const gameTypeHeadingTextStyle = { fontFamily: 'Poppins-regular', fontSize: '36px', fill: '#7F8FA6', fontStyle: 'normal', align: 'center', wordWrap: { width: this.buyinPopupBase.width - 10 } };
    this.gameTypeHeadingText = this.scene.add.text(-280, -260, 'Game Type', gameTypeHeadingTextStyle).setOrigin(0.5);
    const gameTypeDynamicTextStyle = { fontFamily: 'Poppins-regular', fontSize: '36px', fill: '#D2DAE2', fontStyle: 'normal', align: 'center', wordWrap: { width: (this.buyinPopupBase.width / 2) - 10 } };
    this.gameTypeDynamicText = this.scene.add.text(60, -260, this.gameType, gameTypeDynamicTextStyle).setOrigin(0, 0.5);
  ...
  CreateAvailableBalanceText() {
    const availableBalanceHeadingTextStyle = { fontFamily: 'Poppins-regular', fontSize: '36px', fill: '#7F8FA6', fontStyle: 'normal', align: 'center', wordWrap: { width: this.buyinPopupBase.width - 10 } };
    this.availableBalanceHeadingText = this.scene.add.text(-225, -180, 'Available Balance', availableBalanceHeadingTextStyle).setOrigin(0.5);
    this.pokerChip = this.scene.add.image(75, -180, 'poker_chip_popup');
    const gameTypeDynamicTextStyle = { fontFamily: 'Poppins-regular', fontSize: '36px', fill: '#FFF3F2', fontStyle: 'normal', align: 'center', wordWrap: { width: (this.buyinPopupBase.width / 2) - 10 } };
  ...
  CreateAutoBuyInButton() {
    ...
    const buyinPopupBottomBaseTextStyle = { fontFamily: 'Poppins-regular', fontSize: '36px', fill: '#D2DAE2', fontStyle: 'normal', align: 'center', wordWrap: { width: this.autoBuyInButtonBase.width - 10 } };
    this.autoBuyInButtonText = this.scene.add.text(this.autoBuyInButtonBase.x, this.autoBuyInButtonBase.y, 'ACTIVATE AUTO BUY IN & AUTO RE BUY', buyinPopupBottomBaseTextStyle).setOrigin(0.5).setDepth(5);
  };
  //#endregion
  ...
  ResizeAutoBuiInButton(_newWidth, _newHeight, _newScale) {
    ...
    this.autoBuyInButtonBase.setPosition((_newWidth / 2), (_newHeight / 2) + (241 * _newScale));
  ...
  CreateYesButton() {
    ...
    const yesButtonTextStyle = { fontFamily: 'Poppins-Regular', fontSize: '36px   ', fill: '#D2DAE2', fontStyle: 'normal', align: 'center', wordWrap: { width: this.yesButton.width - 10 } };
  ...
  ResizeYesButton(_newWidth, _newHeight, _newScale) {
    ...
    this.yesButton.setPosition((_newWidth / 2) - (156 * _newScale), (_newHeight / 2) + (396 * _newScale));
  ...
  CreateNoButton() {
    ...
    const noButtonTextStyle = { fontFamily: 'Poppins-Regular', fontSize: '36px   ', fill: '#D2DAE2', fontStyle: 'normal', align: 'center', wordWrap: { width: this.noButton.width - 10 } };
    this.noButton.setDepth(5);
  ...
  ResizeNoButton(_newWidth, _newHeight, _newScale) {
    ...
    this.noButton.setPosition((_newWidth / 2) + (156 * _newScale), (_newHeight / 2) + (396 * _newScale));
  ...
  ResizeCloseButton(_newWidth, _newHeight, _newScale) {
    ...
    this.closeButton.setPosition((_newWidth / 2) + (400 * _newScale), (_newHeight / 2) - (520 * _newScale));
  };
  //#endregion

  //#region - Current Amount Section
  CreateCurrentAmountSection() {
    // this.amountChip = this.scene.add.image(-60, -220, 'pot_value_chip').setScale(0.7);
    // this.buyinPopupContainer.add(this.amountChip);
    // const amountTextText = { fontFamily: 'Poppins-Regular', fontSize: '25px', fill: '#897485', fontStyle: 'normal', align: 'center' };
    // const amountText = this.scene.add.text(20, -225, 'Amount', amountTextText).setOrigin(0.5);
    ...
    const amountButtonText = { fontFamily: 'Poppins-Regular', fontSize: '34px', fill: '#fff', fontStyle: 'normal', align: 'center', wordWrap: { width: this.amountBase.width - 10 } };
  ...
  ResizeCurrentAmountSection(_newWidth, _newHeight, _newScale) {
    ...
    this.amountBase.setPosition((_newWidth / 2), (_newHeight / 2) - (15 * _newScale));
  ...
  CreateMinAmountButton() {
    this.minAmountButton = new Button(this.scene, Math.round(this.scene.scale.width / 2), Math.round(this.scene.scale.height), 'buy_in_minmaxamount_base');
    this.minAmountButton.setClickCallback(this.OnMinAmountButtonClicked, this);
    const minAmountButtonText = { fontFamily: 'Poppins-Regular', fontSize: '34px', fill: '#fff', fontStyle: 'normal', align: 'center', wordWrap: { width: this.minAmountButton.width - 10 } };
  ...
  ResizeMinAmountButton(_newWidth, _newHeight, _newScale) {
    ...
    this.minAmountButton.setPosition((_newWidth / 2) - (280 * _newScale), (_newHeight / 2) - (15 * _newScale));
  ...
  CreateMaxAmountButton() {
    this.maxAmountButton = new Button(this.scene, Math.round(this.scene.scale.width / 2), Math.round(this.scene.scale.height), 'buy_in_minmaxamount_base');
    this.maxAmountButton.setClickCallback(this.OnMaxAmountButtonClicked, this);
    const maxAmountButtonText = { fontFamily: 'Poppins-Regular', fontSize: '34px', fill: '#fff', fontStyle: 'normal', align: 'center', wordWrap: { width: this.maxAmountButton.width - 10 } };
  ...
  ResizeMaxAmountButton(_newWidth, _newHeight, _newScale) {
    ...
    this.maxAmountButton.setPosition((_newWidth / 2) + (280 * _newScale), (_newHeight / 2) - (15 * _newScale));
  ...
  CreateBuyAmountSlider() {
    ...
    this.buyAmountSlideBase = this.scene.add.image(this.buyAmountSliderConstantValueObj.basePosX, this.buyAmountSliderConstantValueObj.basePosY, 'buy_in_slider_bar').setOrigin(0);
    this.buyAmountSlideBar = this.scene.add.image(this.buyAmountSliderConstantValueObj.basePosX, this.buyAmountSliderConstantValueObj.basePosY, 'buy_in_slider_base').setOrigin(0);
    this.buyAmountSlideChip = this.scene.add.image(this.buyAmountSliderConstantValueObj.basePosX + 15, this.buyAmountSliderConstantValueObj.basePosY + 7, 'buy_in_slider_chip').setOrigin(0.5);
    this.buyAmountSlideKnob = this.scene.add.image(this.buyAmountSliderConstantValueObj.barPosX + 22.5, this.buyAmountSliderConstantValueObj.barPosY - 8, 'raise_slider').setOrigin(0);
    ...
    this.scene.input.on('drag', (pointer, _gameObject, _dragX) => {
      if (_gameObject.getData('name') === 'BuyinSlider') {
        ...
        const x = ((_dragX / 8.7) + 2) - (this.minRange / 8.7);
  ...
  HidebuyAmountSlide() {
    this.buyAmountSlideKnob.setPosition(this.buyAmountSliderConstantValueObj.barPosX + 22.5, this.buyAmountSliderConstantValueObj.barPosY - 8);
    this.buyAmountSlideBar.setCrop(0, 0, 0, 25);
