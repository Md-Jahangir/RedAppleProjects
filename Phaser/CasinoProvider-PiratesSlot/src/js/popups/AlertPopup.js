...
class AlertPopup {
    ...
    CreateAlertPopup() {
        this.alertPopupContainer = this.scene.add.container(Math.round(constant.game.config.width / 2), Math.round(constant.game.config.height / 2)).setScale(scaleFactorX, scaleFactorY);
