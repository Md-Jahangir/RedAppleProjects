...
class Player {
  constructor(_scene, _posX, _posY) {
    ...
    if (Model.GetGameType() === 'nlh' || Model.GetGameType() === 'plh') {
  ...
  CreateBackCardSection() {
    if (Model.GetGameType() === 'nlh' || Model.GetGameType() === 'plh') {
      this.userBackCard1 = this.scene.add.sprite(this.userBase.x + 25, this.userBase.y - 75, 'front_card_0').setOrigin(0.5).setScale(0.75);
      this.userBackCard1.setAngle(15);
      this.userBackCard1.setFrame(52);
      this.userBackCard2 = this.scene.add.sprite(this.userBase.x - 25, this.userBase.y - 75, 'front_card_0').setOrigin(0.5).setScale(0.75);
      this.userBackCard2.setAngle(345);
