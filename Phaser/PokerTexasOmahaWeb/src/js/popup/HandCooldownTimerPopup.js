...
class HandCoolDownTimerPopup {
  ...
  CreateHandCoolDownTimerPopupData() {
    ...
    const timerValueTextStyle = { fontFamily: 'Poppins-Regular', fontSize: '35px', fill: '#fff', fontStyle: 'bold', align: 'center' };
  ...
  resize(_newWidth, _newHeight, _newScale) {
    ...
    this.timerMsgText.setPosition((_newWidth / 2), (125 * _newScale));
    ...
    this.timerBase.setScale(_newScale * 0.55);
