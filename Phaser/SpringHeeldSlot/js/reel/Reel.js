...
class Reel {
    ...
    create(initialSymbols) {
        this.background = this.scene.add.image(this.x, this.y, "reel_bg").setOrigin(0.5, 0).setScale(scaleFactorX, scaleFactorY);
        ...
        for (let i = 0; i < initialSymbols.length; i++) {
            ...
            symbol.usualImg.y = this.background.y + (i * symbol.getHeight() + (7 * scaleFactorY));
            symbol.spinAnim.y = this.background.y + (i * symbol.getHeight() + (7 * scaleFactorY));
            symbol.winAnim.y = this.background.y + (i * symbol.getHeight() + (7 * scaleFactorY));
