...
export default class GameScene extends Phaser.Scene {
    ...
    createAnims() {
        ...
        let lineNumber = Model.GetLeftPayLineNumber();
        lineNumber.forEach((line) => {
            this.anims.create({
                key: "anim_left_number_blink_" + line,
                frames: this.anims.generateFrameNumbers("left_" + line, {}),
                frameRate: 3,
                repeat: -1
            });
        });
        ...
        lineNumber.forEach((line) => {
            this.anims.create({
                key: "anim_right_number_blink_" + line,
                frames: this.anims.generateFrameNumbers("right_" + line, {}),
                frameRate: 3,
                repeat: -1
            });
        });
