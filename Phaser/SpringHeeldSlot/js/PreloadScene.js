...
export default class PreloadScene extends Phaser.Scene {
    ...
    create() {
        this.splashBg = this.add.image(Math.round(game.config.width / 2), Math.round(game.config.height / 2), "gameplay_bg").setOrigin(0.5, 0.5).setScale(scaleFactorX, scaleFactorY);
        // this.splashLogo = this.add.image(Math.round(game.config.width / 2), Math.round(game.config.height / 2), "highway_heading").setOrigin(0.5, 0.5).setScale(scaleFactor, scaleFactor);
        this.progressBase = this.add.image(Math.round(game.config.width / 2), Math.round(game.config.height / 1.25), "progress_base").setOrigin(0.5, 0.5).setScale(scaleFactor, scaleFactor);
        this.progressBar = this.add.image(Math.round(game.config.width / 2), Math.round(game.config.height / 1.25), "progress_bar").setOrigin(0.5, 0.5).setScale(scaleFactor, scaleFactor);
    ...
    loadAssets() {
        ...
        this.load.image("symbol_character_1", "assets/images/gameplay/reel/symbols/character_1.png");
        this.load.image("symbol_character_2", "assets/images/gameplay/reel/symbols/character_2.png");
        this.load.image("symbol_character_3", "assets/images/gameplay/reel/symbols/character_3.png");
        this.load.image("symbol_scatter", "assets/images/gameplay/reel/symbols/scatter.png");
