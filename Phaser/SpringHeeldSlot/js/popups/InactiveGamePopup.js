...
class InactiveGamePopup {
    ...
    CreateInactiveGamePopup(_message) {
        this.inactiveGamePopupContainer = this.scene.add.container(Math.round(game.config.width / 2), Math.round(game.config.height / 2)).setScale(scaleFactorX, scaleFactorY);
