...
class BottomPanel {
    ...
    create() {
        ...
        this.bottomPanelContainer = this.scene.add.container(Math.round(game.config.width / 2), Math.round(game.config.height / 1)).setScale(scaleFactor, scaleFactor);
        ...
        this.winBase = this.scene.add.image(Math.round(game.config.width) - (40 * scaleFactorX), Math.round(game.config.height / 34), "message_base").setOrigin(1, 0).setScale(scaleFactorX, scaleFactorY);
        let winTextStyle = { fontFamily: 'Roboto_Bold', fontSize: '35px', fill: '#fff', fontStyle: 'bold', align: 'center' };
        this.winText = this.scene.add.text(this.winBase.x - (170 * scaleFactorX), this.winBase.y + (9 * scaleFactorY), "WIN  $ " + Model.getLastWin(), winTextStyle).setOrigin(0.5, 0).setScale(scaleFactorX, scaleFactorY);
    ...
    //==========================================================
    CreateBigWinBase() {
        this.bigWinBase = this.scene.add.image(Math.round(game.config.width / 2), Math.round(game.config.height / 2.2), "big_win_base").setOrigin(0.5, 0.5).setScale(scaleFactorX, scaleFactorY);
        ...
        this.bigWinHeadingText = this.scene.add.text(this.bigWinBase.x, this.bigWinBase.y - (45 * scaleFactorY), "WIN", bigWinHeadingTextStyle).setOrigin(0.5).setScale(scaleFactorX, scaleFactorY);
        ...
        this.bigWinAmountText = this.scene.add.text(this.bigWinHeadingText.x, this.bigWinHeadingText.y + (90 * scaleFactorY), "$ 17", bigWinAmountTextStyle).setOrigin(0.5).setScale(scaleFactorX, scaleFactorY);
    ...
    ShowBigWin() {
        ...
        let scaleTween = this.scene.add.tween({
            ...
            delay: 100,
            scaleX: 1.2 * scaleFactor,
            scaleY: 1.2 * scaleFactor,
            ease: 'Linear',
            duration: 400,
            repeat: -1,
            yoyo: true,
    ...
    onResumeAutoGame() {
        ...
        console.log("this.isAutoMode");
        let totalBalance = Model.getBalance();
        let lines = Model.getLines();
        let betPerLine = Model.getBetPerLine();
        let totalBetAmount = lines * betPerLine;
