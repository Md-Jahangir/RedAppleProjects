...
class GameLogo {
    ...
    create() {
        // this.backButtonGlow = this.scene.add.image(Math.round(game.config.width / 25), Math.round(game.config.height / 19), "back_glow").setOrigin(0.5).setScale(scaleFactor);
        // this.backButtonGlow.setVisible(false);
        // this.backButton = this.scene.add.image(Math.round(game.config.width / 25), Math.round(game.config.height / 19), "gameplay_back_button").setOrigin(0.5).setScale(scaleFactor);
        ...
        // this.logo = this.scene.add.image(Math.round(game.config.width / 2), 0, "highway_heading_with_truck").setOrigin(0.5, 0).setScale(scaleFactorX, scaleFactorY);
    ...
    CreateLeftNumberPanel() {
        ...
        for (let i = 0; i < 9; i++) {
            let slotNumber = this.scene.add.sprite(0, Math.round(game.config.height / 7.2) + (i * Math.round(game.config.height / 13)), "left_" + line[i]).setOrigin(0, 0).setScale(scaleFactorX, scaleFactorY);
    ...
    CreateRightNumberPanel() {
        ...
        for (let i = 0; i < 9; i++) {
            let slotNumber = this.scene.add.sprite(Math.round(game.config.width), Math.round(game.config.height / 7.2) + (i * Math.round(game.config.height / 13)), "right_" + line[i]).setOrigin(1, 0).setScale(scaleFactorX, scaleFactorY);
