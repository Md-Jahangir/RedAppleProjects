...
class GamePreloader extends Phaser.Scene {
    ...
    initialServerDataReceived(_response) {
    ...
    loadAssets() {
        ...
        this.load.image("sound-on-button-normal", "assets/images/" + SelectedResolution.path + "/ui/sound-on-button-normal.png");
        this.load.image("sound-on-button-hover", "assets/images/" + SelectedResolution.path + "/ui/sound-on-button-normal.png");
        this.load.image("sound-on-button-disabled", "assets/images/" + SelectedResolution.path + "/ui/sound-on-button-normal.png");

        this.load.image("sound-off-button-normal", "assets/images/" + SelectedResolution.path + "/ui/sound-off-button-normal.png");
        this.load.image("sound-off-button-hover", "assets/images/" + SelectedResolution.path + "/ui/sound-off-button-normal.png");
        this.load.image("sound-off-button-disabled", "assets/images/" + SelectedResolution.path + "/ui/sound-off-button-normal.png");
        ...
        this.load.image("symbol-Medal", "assets/images/" + SelectedResolution.path + "/reels/symbols/Medal.png");
        ...
        this.load.image("symbol-Star", "assets/images/" + SelectedResolution.path + "/reels/symbols/Star.png");
        ...
        this.load.spritesheet("animation-symbol-Medal", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Medal.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Ring", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Ring.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        ...
        this.load.spritesheet("animation-symbol-Star", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Star.png", { frameWidth: frameWidth, frameHeight: frameHeight });
