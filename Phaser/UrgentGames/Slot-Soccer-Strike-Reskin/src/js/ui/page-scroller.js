...
console.log("this.prevPageButton ",this.prevPageButton);
	...
	setPosition(newX, newY) {
		...
		// 	this.contentContainer.x + (this.width /2 + this.config.scrollButtons.offsetX * this.currentScale ),//(this.width + this.config.scrollButtons.offsetX) * this.currentScale,
		// 	this.contentContainer.y + (this.height / 2 + this.config.scrollButtons.offsetY) * this.currentScale
		// );
