...
class BottomPanel {
    ...
    onSpinResults(response) {
        let spinResults = response.result;
        this.isSpinning = false;
    ...
    resize(newWidth, newHeight) {
        ...
        // this.soundOff.setScale(newScale);
        // this.soundOn.setScale(newScale);
        // this.soundOn.setPosition();
        // let y = newHeight - this.panelBg.displayHeight ;
        // let y = newHeight/2  + this.config.bottomPanel.y * newScale;
        ...
        // this.soundOn.setPosition(newWidth/2 - this.config.soundButton.x,newHeight-this.config.soundButton.y);
        // this.soundOff.setPosition(newWidth/2 - this.config.soundButton.x,newHeight-this.config.soundButton.y);
        ...
        // );
        this.betsSwitcher.setPosition(
            // newWidth * 0.33,//newWidth / 2 - this.config.betsSwitcher.x * newScale,
            newWidth / 2 - this.config.betsSwitcher.x * newScale,
            // newWidth * 0.32,//newWidth / 2 - this.config.betsSwitcher.x * newScale,
            this.panelBg.y + this.config.betsSwitcher.y * newScale
        );
