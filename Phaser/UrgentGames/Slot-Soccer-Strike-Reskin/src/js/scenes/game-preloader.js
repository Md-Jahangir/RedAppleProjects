...
class GamePreloader extends Phaser.Scene {
    ...
    loadAssets() {
        ...
        this.load.image("popup-bg", "assets/images/" + SelectedResolution.path + "/ui/popups/pop-bg.png");
        ...
        this.load.spritesheet("animation-symbol-Gloves", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Gloves.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        ...
        this.load.spritesheet("animation-symbol-Score Board", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/ScoreBoard.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        ...
        this.load.spritesheet("animation-symbol-Shoes", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Shoes.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Strike", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Strike.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        ...
        this.load.spritesheet("animation-symbol-Whistle", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Whistle.png", { frameWidth: frameWidth, frameHeight: frameHeight });
