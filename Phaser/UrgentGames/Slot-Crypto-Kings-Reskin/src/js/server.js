...
class Server {
    constructor() {
        ...
        this.token = this.urlParams.get("token");//|| "387";
        this.gameId = this.urlParams.get("game_id") || "515";
        ...
        // this.baseData = "/games/admin?token=" + this.token + "&game_id=" + this.gameId + "&casino=" + this.casino + "&remote_id=" + this.remoteId;
