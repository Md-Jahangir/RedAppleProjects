...
class GamePreloader extends Phaser.Scene {
    ...
    loadAssets() {
        ...
        this.load.image("popup-minus-normal", "assets/images/" + SelectedResolution.path + "/ui/popups/popup-minus-normal.png");
        this.load.image("popup-minus-hover", "assets/images/" + SelectedResolution.path + "/ui/popups/popup-minus-hover.png");
        this.load.image("popup-minus-disabled", "assets/images/" + SelectedResolution.path + "/ui/popups/popup-minus-normal.png");

        this.load.image("popup-plus-normal", "assets/images/" + SelectedResolution.path + "/ui/popups/popup-plus-normal.png");
        this.load.image("popup-plus-hover", "assets/images/" + SelectedResolution.path + "/ui/popups/popup-plus-hover.png");
        this.load.image("popup-plus-disabled", "assets/images/" + SelectedResolution.path + "/ui/popups/popup-plus-normal.png");
        ...
        this.load.image("back-button-normal", "assets/images/" + SelectedResolution.path + "/ui/popups/back-button.png");
        this.load.image("back-button-hover", "assets/images/" + SelectedResolution.path + "/ui/popups/back-button.png");
        this.load.image("back-button-disabled", "assets/images/" + SelectedResolution.path + "/ui/popups/back-button.png");
        this.load.image("symbol-Bear", "assets/images/" + SelectedResolution.path + "/reels/symbols/Bear.png");
        this.load.image("symbol-Block", "assets/images/" + SelectedResolution.path + "/reels/symbols/Block.png");
        this.load.image("symbol-Blockchain", "assets/images/" + SelectedResolution.path + "/reels/symbols/Blockchain.png");
        this.load.image("symbol-Bonus", "assets/images/" + SelectedResolution.path + "/reels/symbols/Bonus.png");
        this.load.image("symbol-BTC", "assets/images/" + SelectedResolution.path + "/reels/symbols/BTC.png");
        this.load.image("symbol-Bull", "assets/images/" + SelectedResolution.path + "/reels/symbols/Bull.png");
        this.load.image("symbol-Free Spin", "assets/images/" + SelectedResolution.path + "/reels/symbols/FreeSpin.png");
        this.load.image("symbol-Lock", "assets/images/" + SelectedResolution.path + "/reels/symbols/Lock.png");
        this.load.image("symbol-Moon", "assets/images/" + SelectedResolution.path + "/reels/symbols/Moon.png");
        this.load.image("symbol-Rocket", "assets/images/" + SelectedResolution.path + "/reels/symbols/Rocket.png");
        this.load.image("symbol-Wallet", "assets/images/" + SelectedResolution.path + "/reels/symbols/Wallet.png");
        ...
        this.load.spritesheet("animation-symbol-Bear", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Bear.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Block", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Block.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Blockchain", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Blockchain.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        ...
        this.load.spritesheet("animation-symbol-BTC", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/BTC.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Bull", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Bull.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        ...
        this.load.spritesheet("animation-symbol-Lock", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Lock.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Moon", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Moon.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Rocket", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Rocket.png", { frameWidth: frameWidth, frameHeight: frameHeight });
        this.load.spritesheet("animation-symbol-Wallet", "assets/images/" + SelectedResolution.path + "/reels/symbols/animation/Wallet.png", { frameWidth: frameWidth, frameHeight: frameHeight });
