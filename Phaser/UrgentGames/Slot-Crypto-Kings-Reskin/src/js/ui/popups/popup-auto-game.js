...
class PopupAutoGame extends PopupBase {
    ...
    createContent() {
        ...
        this.contentTitle = this.scene.add.image(this.backgroundContainer.x + this.width / 2,
            this.backgroundContainer.y + this.contentConfig.title.y, "auto_game_heading").setOrigin(0.5);
        ...
        this.gamesCountSwitcher = new ValueSwitcher(
            ...
            this.backgroundContainer.y + this.contentConfig.gamesCount.y, [5, 10, 15, 20, 25], {
                decrementImg: "popup-minus",
                incrementImg: "popup-plus",
