...
class PopupBonus extends PopupBase {
    ...
    resizeContent(newWidth, newHeight, newScale) {
        ...
        this.contentTitle.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.8, this.backgroundContainer.y + this.contentConfig.title.y * newScale);

        this.contentMessage.setScale(newScale);
        this.contentMessage.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.8, this.contentTitle.y + this.contentConfig.message.y * newScale);

        this.contentCoins.setScale(newScale);
        this.contentCoins.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.8, this.contentMessage.y + this.contentConfig.coins.y * newScale);

        this.contentCoinsAmount.setScale(newScale);
        this.contentCoinsAmount.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.8, this.contentCoins.y + this.contentConfig.coins.text.y * newScale);
    };
}
