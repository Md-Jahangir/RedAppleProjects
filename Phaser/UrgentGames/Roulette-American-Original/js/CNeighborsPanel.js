function CNeighborsPanel() {
    ...
    this._init = function() {
        ...
        _oMoneyText = new createjs.Text(_iTotMoney + languageService.serverCurrency("currencySymbol"), "20px " + FONT1, "#fff");
    ...
    this.showPanel = function(iIndexFicheSelected, iMoney, iCurBet) {
        ...
        _oMoneyText.text = iMoney + languageService.serverCurrency("currencySymbol");
    ...
    this.addFicheOnNeighborTable = function() {
        ...
        if ((_iCurBet + (iFicheValue * 5)) > _iTotMoney) {
            ...
            _oMoneyText.text = iAmount + languageService.serverCurrency("currencySymbol");
        }
