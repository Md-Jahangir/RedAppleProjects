function CSeat() {
    ...
    this.increaseCredit = function(iCreditToAdd) {
        ...
        if (mode == 'offline') {
            ...
            _iCredit = serverRequests.updateWinAmount(iCreditToAdd);
            _iCredit = parseFloat(_iCredit);

        }
    };

    this.increaseCreditOld = function(iCreditToAdd) {
        _iCredit += iCreditToAdd;
    };
