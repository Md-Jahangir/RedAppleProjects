function CHandEvaluator(){
    ...
    this.evaluateV1 = function(aHand){
        var iRes;
        aHand=JSON.stringify(aHand);
        
        $.ajax({
            url: BASE_URL+'?game_id=110&action=evaluate&isGameLogic=true&aHand='+aHand,  
    ...
    this.getWinnerComparingHands = function(aHandPlayer,aHandDealer,iHandPlayerValue,iHandDealerValue){
        ...
        iRes=serverRequests.winnerComparingHands(aHandPlayer,aHandDealer,iHandPlayerValue,iHandDealerValue);
            iRes=iRes.result;            
            return iRes;    
    ...
    this.getWinnerComparingHandsOld = function(aHandPlayer,aHandDealer,iHandPlayerValue,iHandDealerValue){
