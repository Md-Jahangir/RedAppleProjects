...
function CRollingTextController(oTarget, oTargetStroke, iStartAmount, iAmountToIncrease, iTime, szEasing, szTextAppend) {
    ...
    this.update = function() {
        ...
        if (_iCntFrames > _iMaxFrames) {
            ...
            _oTarget.text = _szTextAppend + _iTotWin.toFixed(2);
            if (_oTargetStroke !== null) {
                _oTargetStroke.text = _szTextAppend + _iTotWin.toFixed(2);
            }
        ...
        _oTarget.text = _szTextAppend + iValue.toFixed(2);
        if (_oTargetStroke !== null) {
            _oTargetStroke.text = _szTextAppend + iValue.toFixed(2);
        }
    };
