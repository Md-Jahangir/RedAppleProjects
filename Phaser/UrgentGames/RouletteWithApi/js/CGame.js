function CGame(oData) {
    ...
    var _sid, _bettedFiches = [],
        _iUserMoney, _iUserWin, waitForServeResponse = false;
    ...
    this.onSpin = function() {
        ...
        if (mode != 'offline') {
            serverRequests.deductBetAmount(currBet);
        }
        var thisRef = this;
    ...
    this._deductAmountFromWallet = function() {
        _oMySeat.sendBetToServer(_oMySeat.getCurBet());
        _oInterface.setMoney(_oMySeat.getCredit());
