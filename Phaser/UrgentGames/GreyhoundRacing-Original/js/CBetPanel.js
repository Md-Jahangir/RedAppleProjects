function CBetPanel(){
    ...
    this.setSimpleBet = function(iIndex,iPlace,iFicheValue,oBut){
        if( (_iTotBet+iFicheValue) > MAX_BET){
            ...
            _oMsgBox.show(languageService.getString("TEXT_ERR_MAX_BET"));
        ...
        if(iFicheValue > s_iCurMoney ){
            ...
            _oMsgBox.show(languageService.getString("TEXT_NO_MONEY"));
        ...
        if(mode=="offline"){
            ...
            s_iCurMoney= serverRequests.deductBetAmount(iFicheValue);
            
            s_iCurMoney=parseFloat(s_iCurMoney);
            s_iCurMoney=parseFloat(s_iCurMoney.toFixed(2));
        }
       // s_iCurMoney -= iFicheValue;
       // s_iCurMoney = parseFloat(s_iCurMoney.toFixed(2));
    ...
    this.clearBet = function(){
        ...
        if(mode=="offline"){
            ...
            s_iCurMoney =serverRequests.updateWinAmount(_iTotBet);
            s_iCurMoney=parseFloat(s_iCurMoney);
            s_iCurMoney = parseFloat(s_iCurMoney.toFixed(2));
    ...
    this.onStartExit = function(){
        if(_iTotBet < MIN_BET){
            _oMsgBox.show(languageService.getString("TEXT_ERR_MIN_BET"));
        }else{
            this.unload();
