function CSimpleBetPanel(iX,iY,oParentContainer){
    ...
    this._init = function(iX,iY){
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_TRAP"), "20px " + PRIMARY_FONT, "#fff");
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_GREYHOUND_NAME"), "20px " + PRIMARY_FONT, "#fff");
        oText.textAlign = "center";
        oText.textBaseline = "alphabetic";
        oText.x = 180;
        oText.y = 24;
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_WINS"), "20px " + PRIMARY_FONT, "#fff");
        oText.textAlign = "center";
        oText.textBaseline = "alphabetic";
        oText.x = 360;
        oText.y = 24;
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_PLACE"), "20px " + PRIMARY_FONT, "#fff");
        oText.textAlign = "center";
        oText.textBaseline = "alphabetic";
        oText.x = 500;
        oText.y = 24;
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_SHOW"), "20px " + PRIMARY_FONT, "#fff");
        oText.textAlign = "center";
        oText.textBaseline = "alphabetic";
        oText.x = 630;
        oText.y = 24;
