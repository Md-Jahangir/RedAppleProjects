function CChipPanel(iX,iY,oParentContainer){
    ...
    this._init = function(iX,iY){
        ...
        _oClearBet = new CTextButton(73,2,s_oSpriteLibrary.getSprite("but_clear_bet"), languageService.getString("TEXT_CLEAR_BET"), PRIMARY_FONT, "#fff", 24,_oContainer);
        ...
        _oTextMinBet = new createjs.Text(languageService.getString("TEXT_MIN_BET") + ": " + MIN_BET + languageService.serverCurrency("currencySymbol"), "14px " + SECONDARY_FONT, "#ffde00");
        ...
        _oTextMaxBet = new createjs.Text(languageService.getString("TEXT_MAX_BET") + ": " + MAX_BET + languageService.serverCurrency("currencySymbol"), "14px " + SECONDARY_FONT, "#ffde00");
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_BET"), "11px " + TERTIARY_FONT, "#fff");
        ...
        _oTextBet = new createjs.Text("0"+languageService.serverCurrency("currencySymbol"), "26px " + SECONDARY_FONT, "#ffde00");
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_MONEY"), "11px " + TERTIARY_FONT, "#fff");
        oText.textAlign = "left";
        oText.textBaseline = "alphabetic";
        oText.x = 3;
        oText.y = 136;
        ...
        _oTextMoney = new createjs.Text(s_iCurMoney+languageService.serverCurrency("currencySymbol"), "26px " + SECONDARY_FONT, "#ffde00");
        ...
        _oButStartRace = new CButStartRace(73,304,s_oSpriteLibrary.getSprite("but_start_race"), languageService.getString("TEXT_START_RACE"), "#fff", 24,_oContainer);
    ...
    this.refreshMoney = function(){
        _oTextMoney.text = s_iCurMoney+languageService.serverCurrency("currencySymbol");
    };
    
    this.refreshBet = function(iBet){
        _oTextBet.text = iBet+languageService.serverCurrency("currencySymbol");
    };
