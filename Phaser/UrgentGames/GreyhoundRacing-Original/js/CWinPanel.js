function CWinPanel(oParentContainer){
    ...
    this._init = function(){
        ...
        _oWinText = new createjs.Text(languageService.getString("TEXT_WIN"), "30px " + SECONDARY_FONT, "#ffde00");
    ...
    this.show = function(iWin,aWinList,aRank){
        _oWinText.text = languageService.getString("TEXT_WIN") + "\n"+iWin+languageService.serverCurrency("currencySymbol");
        ...
        for(var i=0;i<aWinList.length;i++){
            ...
            var oTextWin = new createjs.Text(languageService.getString("TEXT_WIN") + ": " + aWinList[i].win + languageService.serverCurrency("currencySymbol"), "16px " + PRIMARY_FONT, "#fff");
