function CLosePanel(oParentContainer){
    ...
    this._init = function(){
        ...
        var oText = new createjs.Text(languageService.getString("TEXT_NO_WIN"), "50px " + PRIMARY_FONT, "#fff");
        ...
        _oWinText = new createjs.Text(languageService.getString("TEXT_WIN") + ": 0.00 " + languageService.serverCurrency("currencySymbol"), "30px " + PRIMARY_FONT, "#fff");
