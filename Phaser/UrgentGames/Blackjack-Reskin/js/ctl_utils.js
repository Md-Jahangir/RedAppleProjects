...
let NEW_WIDTH = 1920;
let NEW_HEIGHT = 1080;
var CARD_ORDER_DEALER = null
var CARD_ORDER_PLAYER = null
var CARD_ORDER_PLAYER_SPLIT = null
...
function resize() {
  ...
  GAME_SCALE = getScale(NEW_WIDTH, NEW_HEIGHT);
  canvas = document.getElementById('canvas');
  canvas.width = NEW_WIDTH;
  canvas.height = NEW_HEIGHT;
}

function getScale(screenNewWidth, screenNewHeight) {
...
function getOrientation() {
  let orientation = 'orientation_landscape';
...
var currScreenWidth, currScreenHeight, currGameScaleVal;
