function CMain(oData) {
    ...
    this._loadImages = function () {
        ...
        s_oSpriteLibrary.addSprite("message-box", "./sprites/message-box.png");
        ...
        s_oSpriteLibrary.addSprite('info_icon', './sprites/info_icon.png');
        s_oSpriteLibrary.addSprite('company_logo', './sprites/casino_logo.png');
        s_oSpriteLibrary.addSprite('game_logo', './sprites/Baccarat.png');
    ...
    this._onRemovePreloader = async function () {
        _oPreloader.unload();

        await languageService.init();
        
        const initData = await serverRequests.initGame();

        if (initData) {
            _oGame = new CGame({ ..._oData, ...initData.result });
    ...
    //! update game total cash with server
    this.updateGameMoney = function (cash) {
        _oGame.setMoney(cash);
    };
