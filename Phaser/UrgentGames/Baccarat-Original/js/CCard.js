function CCard(iX,iY,oContainer){
    ...
    this.showCard = function(){
        var oParent = this;
        createjs.Tween.get(_oCardSprite).to({scaleX:0.1}, 200).call(function(){oParent.setValue()});//100
    };
		
    this.hideCard = function(){
        var oParent = this;
        createjs.Tween.get(_oCardSprite).wait(500).to({scaleX:0.1}, 200).call(function(){oParent.setBack()});//100
    };
