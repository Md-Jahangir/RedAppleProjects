function CInterface() {
    ...
    this._init = function() {
        ...
        _oMsgTitle = new CTLText(s_oStage,
            ...
            0, 0,
            languageService.getString("TEXT_MIN_BET") + ": " + MIN_BET + "\n" + languageService.getString("TEXT_MAX_BET") + ": " + MAX_BET,
            true, true, true,
            false);
        ...
        _oRollBut = new CTextButton(1030, 162, s_oSpriteLibrary.getSprite('roll_but'), "  " + languageService.getString("TEXT_ROLL"), FONT1, "#fff", 22, "right", s_oStage);
        _oRollBut.disable();
        ...
        if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
            ...
            _pStartPosAudio = { x: _pStartPosExit.x, y: (oSprite.height / 2) + 10 };
    ...
    this.setMoney = function(iMoney) {
        _oMoneyAmountText.refreshText(parseFloat(iMoney).toFixed(languageService.serverCurrency("currencyDecimils")) + languageService.serverCurrency("currencySymbol"));
    };
    ...
    this.setCurBet = function(iCurBet) {
        _oBetAmountText.refreshText(iCurBet.toFixed(languageService.serverCurrency("currencyDecimils")) + languageService.serverCurrency("currencySymbol"));
    };
