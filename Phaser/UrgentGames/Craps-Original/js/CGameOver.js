function CGameOver(){
    ...
    this._init = function(){
        ...
        _ButRecharge = new CTextButton(CANVAS_WIDTH/2 + 170,510,s_oSpriteLibrary.getSprite('but_bg'),languageService.getString("TEXT_RECHARGE"),FONT1,"#fff",18,"center",s_oStage);
        _ButRecharge.addEventListener(ON_MOUSE_UP, this._onRecharge, this);
        _oContainer.addChild(_ButRecharge.getSprite());
        
        _oButExit = new CTextButton(CANVAS_WIDTH/2 - 170,510,s_oSpriteLibrary.getSprite('but_bg'),languageService.getString("TEXT_EXIT"),FONT1,"#fff",18,"center",s_oStage);
