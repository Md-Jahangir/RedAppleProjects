function CDicesAnim(iX, iY) {
    ...
    this._init = function(iX, iY) {
        ...
        var oSprite = s_oSpriteLibrary.getSprite("dices_screen_bg");
        _oBgDiceLaunch = createBitmap(oSprite);
        // _oBgDiceLaunch.x = CANVAS_WIDTH / 2;
        // _oBgDiceLaunch.y = CANVAS_HEIGHT / 2;
        // _oBgDiceLaunch.regX = oSprite.width / 2;
        // _oBgDiceLaunch.regY = oSprite.height / 2;
        _oContainer.addChild(_oBgDiceLaunch);

        var oSprite = s_oSpriteLibrary.getSprite("dices_screen_bg_come");
        _oComeTextBgDiceLaunch = createBitmap(s_oSpriteLibrary.getSprite("dices_screen_bg_come"));
        _oComeTextBgDiceLaunch.x = CANVAS_WIDTH / 2;
        _oComeTextBgDiceLaunch.y = CANVAS_HEIGHT / 2;
        _oComeTextBgDiceLaunch.regX = oSprite.width / 2;
        _oComeTextBgDiceLaunch.regY = oSprite.height / 2;
        _oContainer.addChild(_oComeTextBgDiceLaunch);
