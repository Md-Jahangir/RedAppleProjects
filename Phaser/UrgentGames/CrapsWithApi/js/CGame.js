function CGame(oData) {
    ...
    //     console.log("c game refreshButtonPos");
    //     _oTableController.refreshButtonPos();
    // };
    ...
    this._generateRandomDices = function() {
        var aRandDicesRandomDicesResp = serverRequests._generateRandomDices();
        // $.ajax({
        //     url: BASE_URL + "?game_id=108&action=getRandomDices&isGameLogic=true",
        //     async: false,

        //     success: function(data) {
        //         aRandDicesRandomDices = data.result;

        //     }
        // });
        return aRandDicesRandomDicesResp.result;
    ...
    this._checkHardwayWin = function(szBet) {
        ...
        // $.ajax({
        //     url: BASE_URL + "?game_id=108&action=checkHardwayWin&isGameLogic=true&szBet=" + szBet,
        //     async: false,

        //     success: function(data) {

        //         aRandDicesHardwayWin = data.result;

        //     }
        // });
        return aRandDicesHardwayWinResp.result;
