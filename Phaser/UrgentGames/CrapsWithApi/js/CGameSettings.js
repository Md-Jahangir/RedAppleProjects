function CGameSettings() {
    ...
    this.getBetWinLoss = function(iState, iNumberPoint, szBet) {
        ...
        var aRandDicesResp = serverRequests.getBetWinLoss(iState, iNumberPoint, szBet);

        // $.ajax({
        //     url: BASE_URL + '?game_id=108&action=getBetWinLoss&isGameLogic=true&iState=' + iState + "&iNumberPoint=" + iNumberPoint + "&szBet=" + szBet,

        //     async: false,

        //     success: function(data) {
        //         aRandDices = data.result;
        //         console.log("aRandDices: ", aRandDices);
        //     }
        // });

        console.log("aRandDices: ", aRandDicesResp.result);
    ...
    this.checkBetWin = function(iSumDices, iState, iAmountForBet, iNumberPoint, szBet, aDiceResult) {
        ...
        // $.ajax({
        //     url: BASE_URL + '?game_id=108&action=checkBetWin&isGameLogic=true&iSumDices=' + iSumDices + "&iState=" + iState + "&szBet=" + szBet + "&iAmountForBet" + iAmountForBet + "&iNumberPoint=" + iNumberPoint + "&aDiceResult=" + aDiceResult,
