...
class ReelsView {
    ...
    create() {
        this.reelBackground = this.scene.add.image(0, 0, "reel-back-bg").setOrigin(0);
    ...
    resize(newWidth, newHeight) {
        ...
        this.reelBackground.setScale(newScale);
        this.reelBackground.setPosition(this.getX(), this.getY());

        this.gameLogoView.resize(this.getX(), newScale, this.getY());
