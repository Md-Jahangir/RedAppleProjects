function CGameSettings() {
    ...
    this._initAttachFiches = function() {
        ...
        _aAttachFiches["pass_line"] = { x: 285, y: 527 };
        _aAttachFiches["dont_pass1"] = { x: 520, y: 493 };
        _aAttachFiches["dont_pass2"] = { x: 208, y: 380 };
        _aAttachFiches["dont_come"] = { x: 255, y: 315 };
        _aAttachFiches["come"] = { x: 510, y: 377 };
        _aAttachFiches["field"] = { x: 395, y: 437 };
        _aAttachFiches["big_6"] = { x: 214, y: 450 };
        _aAttachFiches["big_8"] = { x: 250, y: 488 };

        var aData = [{ value: 4, x: 322, y: 250 }, { value: 5, x: 379, y: 250 }, { value: 6, x: 436, y: 250 }, { value: 8, x: 492, y: 250 }, { value: 9, x: 549, y: 250 }, { value: 10, x: 606, y: 250 }];
        for (var i = 0; i < aData.length; i++) {
            _aAttachFiches["lay_bet" + aData[i].value] = { x: aData[i].x, y: aData[i].y };
            _aAttachFiches["lose_bet" + aData[i].value] = { x: aData[i].x - 25, y: aData[i].y + 20 };
            _aAttachFiches["number" + aData[i].value] = { x: aData[i].x - 12, y: aData[i].y + 50 };
            _aAttachFiches["win_bet" + aData[i].value] = { x: aData[i].x - 12, y: aData[i].y + 82 };
        }

        _aAttachFiches["any11_7"] = { x: 1000, y: 493 };
        _aAttachFiches["any_craps_7"] = { x: 1000, y: 531 };
        _aAttachFiches["seven_bet"] = { x: 1000, y: 304 };
        _aAttachFiches["hardway6"] = { x: 936, y: 336 };
        _aAttachFiches["hardway10"] = { x: 1064, y: 336 };
        _aAttachFiches["hardway8"] = { x: 936, y: 386 };
        _aAttachFiches["hardway4"] = { x: 1064, y: 386 };
        _aAttachFiches["horn3"] = { x: 916, y: 435 };
        _aAttachFiches["horn2"] = { x: 1002, y: 435 };
        _aAttachFiches["horn12"] = { x: 1085, y: 435 };
