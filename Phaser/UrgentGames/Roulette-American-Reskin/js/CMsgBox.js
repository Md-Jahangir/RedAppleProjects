...
function CMsgBox() {
    ...
    this._init = function() {
        ...
        _oMsgTextBack = new createjs.Text("", "30px " + FONT1, "#000");
        _oMsgTextBack.x = CANVAS_WIDTH / 2 + 2;
        _oMsgTextBack.y = (CANVAS_HEIGHT / 2) - 15;
        _oMsgTextBack.textAlign = "center";
        _oMsgTextBack.lineWidth = 500;

        _oMsgText = new createjs.Text("", "30px " + FONT1, "#ffffff");
        _oMsgText.x = CANVAS_WIDTH / 2;
        _oMsgText.y = (CANVAS_HEIGHT / 2) - 15;
