function CWheelAnim(iX, iY) {
    ...
    this._init = function(iX, iY) {
        ...
        _oResultText.y = oSprite.height - 110;
    ...
    this.startSpin = function(iRandSpin, iStartFrame, iNumExtracted, iWin) {
        console.log("startSpin: " + iNumExtracted);
    ...
    this.setShowNumberInfo = function(iNumExtracted) {
        ...
        if (_iWin > 0) {
            ...
            _oResultText.text = languageService.getString("TEXT_YOU_WIN") + " " + languageService.serverCurrency("currencySymbol") + _iWin;
        } else {
            _oResultText.font = "22px " + FONT1;
            _oResultText.text = languageService.getString("TEXT_YOU_LOSE");
        }
