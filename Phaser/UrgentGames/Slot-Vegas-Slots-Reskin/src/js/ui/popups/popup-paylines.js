...
// this.topLogo.setPosition( (this.width * newScale) /1.13 - (this.topLogo.displayWidth * newScale),(this.height * newScale) / 5.5);
		this.topLogo.setPosition( newWidth/2 - (this.topLogo.displayWidth * newScale)/10,(this.height * newScale) / 5.8);
	
		this.bottomLogo.setPosition(newWidth/2 - (this.bottomLogo.displayWidth * newScale)/25 ,newHeight - (this.bottomLogo.displayHeight * newScale)/1.5);
		// this.bottomLogo.setPosition(newWidth/2 - (this.bottomLogo.displayWidth * newScale)/25 ,newHeight - (this.bottomLogo.displayHeight * newScale)/2.3);
...
console.log("newHeight - (this.bottomLogo.displayHeight * newScale)/2.3 ",newHeight - (this.bottomLogo.displayHeight * newScale)/2.3);
