...
class PopupBonus extends PopupBase {
    ...
    resizeContent(newWidth, newHeight, newScale) {
        ...
        this.contentMessage.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.7, this.contentTitle.y + this.contentConfig.message.y * newScale);

        this.contentCoins.setScale(newScale);
        this.contentCoins.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.7, this.contentMessage.y + this.contentConfig.coins.y * newScale);

        this.contentCoinsAmount.setScale(newScale);
        this.contentCoinsAmount.setPosition(this.backgroundContainer.x + (this.width * newScale) / 1.7, this.contentCoins.y + this.contentConfig.coins.text.y * newScale);
    };
}
