function CInterface(iMoney) {
    ...
    this._init = function(iMoney) {
        ...
        _oClearBetBut = new CTextButton(444, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textClear"), FONT_GAME_1, "#ffffff", 14, s_oStage);
        _oClearBetBut.addEventListener(ON_MOUSE_UP, this._onButClearRelease, this);

        _oRebetBut = new CTextButton(632, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textRebet"), FONT_GAME_1, "#ffffff", 14, s_oStage);
        ...
        _oDisplayText2 = new createjs.Text("", "18px " + FONT_GAME_2, "#ffde00");
        ...
        _oMoneyText = new createjs.Text(languageService.serverCurrency("currencySymbol") + iMoney.toFixed(languageService.serverCurrency('currencyDecimils')), "29px " + FONT_GAME_2, "#ffde00");
        ...
        _oDealBut = new CTextButton(908, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textDeal"), FONT_GAME_1, "#ffffff", 20, s_oStage);
        _oDealBut.addEventListener(ON_MOUSE_UP, this._onButDealRelease, this);

        _oHitBut = new CTextButton(1008, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textHit"), FONT_GAME_1, "#ffffff", 20, s_oStage);
        _oHitBut.addEventListener(ON_MOUSE_UP, this._onButHitRelease, this);

        _oStandBut = new CTextButton(1108, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textStand"), FONT_GAME_1, "#ffffff", 20, s_oStage);
        _oStandBut.addEventListener(ON_MOUSE_UP, this._onButStandRelease, this);

        _oDoubleBut = new CTextButton(1208, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textDouble"), FONT_GAME_1, "#ffffff", 20, s_oStage);
        _oDoubleBut.addEventListener(ON_MOUSE_UP, this._onButDoubleRelease, this);

        _oSplitBut = new CTextButton(1308, CANVAS_HEIGHT - 30, oSprite, languageService.getString("textSplit"), FONT_GAME_1, "#ffffff", 20, s_oStage);
    ...
    this.refreshCredit = function(iMoney) {
        _oMoneyText.text = languageService.serverCurrency("currencySymbol") + parseFloat(iMoney).toFixed(languageService.serverCurrency("currencyDecimils"));
    };
    ...
    this.showInsurancePanel = function() {
        _oInsurancePanel.show(languageService.getString("textInsurance"));
    };
