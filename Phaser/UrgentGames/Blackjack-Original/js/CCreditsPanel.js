function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        _oButExit = new CTextButton(_pStartPosExit.x, _pStartPosExit.y, oSprite, languageService.getString("textExit"), FONT_GAME_1, "#ffffff", 40, s_oStage);
        _oButExit.addEventListener(ON_MOUSE_UP, this.unload, this);
       
        _oMsgTextOutline = new createjs.Text(languageService.getString("textCreditsDeveloped"), "38px " + FONT_GAME_1, "#000");
	...
	_oContainer.addChild(_oMsgTextOutline);
        ...
        _oMsgText = new createjs.Text(languageService.getString("textCreditsDeveloped"), "38px " + FONT_GAME_1, "#fff");
	...
	_oContainer.addChild(_oMsgText);
        ...
        _oLinkOutline = new createjs.Text("www.kaouch.com", "36px " + FONT_GAME_1, "#000");
	...
	_oLinkOutline.x = CANVAS_WIDTH/2;
        ...
        _oLink = new createjs.Text("www.kaouch.com", "36px " + FONT_GAME_1, "#fff");
    ...
    this._onLogoButRelease = function(){
        window.open("https://www.kaouch.com/index.html","_blank");
    };
