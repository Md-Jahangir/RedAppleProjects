function CMenu() {
    ...
    this._init = function() {
        ...
        const txtply = languageService.getString("textPlay");
        _oButPlay = new CTextButton((CANVAS_WIDTH / 2), CANVAS_HEIGHT - 164, oSprite, txtply, FONT_GAME_1, "#ffffff", 40, s_oStage);
