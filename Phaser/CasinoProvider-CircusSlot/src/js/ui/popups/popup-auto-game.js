...
class PopupAutoGame extends PopupBase {
     ...
     */
    createContent() {
        this.bg = this.scene.add.image(0, 0, "auto_popup_overlay").setOrigin(0);
        this.popBg = this.scene.add.image(0, 0, "auto_popup_frame").setOrigin(0);
    ...
    onAccept() {
        if ((this.gamesCountSwitcher.getValue() * this.scene.bottomPanel.betsSwitcher.valueMultiplier) >
            ...
            // this.scene.bottomPanel.isAutoMode = true;
    ...
    resizeContent(newWidth, newHeight, newScale) {
        // this.bg.setScale(newScale);
        // this.bg.setPosition(
        //     newWidth / 2 - (this.bg.displayWidth / 2) * newScale,
        //     newHeight / 2 - (this.bg.displayHeight / 2) * newScale
        // );
        ...
        this.popBg.setPosition(
            ...
            newWidth / 2 - (this.popBg.displayWidth / 2) * newScale,
            newHeight / 2 - (this.popBg.displayHeight / 2) * newScale
        );
        ...
        this.contentTitle.setPosition(
            ...
            this.popBg.x + (this.width) * newScale,
