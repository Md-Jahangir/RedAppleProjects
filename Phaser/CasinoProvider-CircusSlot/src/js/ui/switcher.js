...
class Switcher {
	...
	constructor(scene, x, y, ballOffset, ballOffsetY, isOff = false) {
		this.scene = scene;
		this.isOff = isOff;
		this.ballOffset = ballOffset || 0;
		this.ballOffsetY = ballOffsetY || 0;
	...
	create() {
		...
		this.backgroundOff = this.scene.add.image(this.x, this.y, "music_sound_off_base").setOrigin(0, 0.5);
		this.backgroundOff.setInteractive({ useHandCursor: true });
		...
		this.backgroundOn = this.scene.add.image(this.x, this.y, "music_sound_on_base").setOrigin(0, 0.5);

		// this.ball = this.scene.add.image(this.backgroundOff.x, this.backgroundOff.y, "switch-ball");
		this.ball = this.scene.add.image(this.backgroundOff.x, this.backgroundOff.y, "switch_ball");
	...
	setPosition(newX, newY) {
		...
		this.ball.setPosition(
			...
			this.backgroundOff.y - this.ballOffsetY
		);
	};
	//#############################################################################################
	getOffPosition() {
