...
export default class GameErrorScene extends Phaser.Scene {
    ...
    create() {
        ...
        let errorTextStyle = { fontFamily: 'Aileron-Regular', fontSize: '45px', fill: '#fff', fontStyle: 'bold', align: 'center', wordWrap: { width: Math.round(Constant.game.config.width - 100) } };
