...
export default class GameOver {
    ...
    Create() {
        ...
        this.gameOverText = this.scene.add.text(0, -150, "GameOver!", { fontFamily: "LILITAONE", fontSize: 100 })
            .setOrigin(0.5)
        this.scoreText = this.scene.add.text(-40, -10, "Score : ", { fontFamily: "LILITAONE", fontSize: 60, color: "#cca070" })
            .setOrigin(0.5)
        this.scoreDisplayText = this.scene.add.text(60, -45, this.totalDistance, { fontFamily: "LILITAONE", fontSize: 60, color: "#cca070", align: 'left' })
            .setOrigin(0)
        ...
        //add to container
        this.gameOverContainer.add([this.gameOverBase, this.gameOverText, this.scoreText, this.scoreDisplayText, this.replayButton.button, this.homeButton.button])
            .setDepth(2)
            .setVisible(false)
            .setScrollFactor(0);
    }
    ...
    //#region -Show
    Show() {
        this.scoreDisplayText.setText(this.totalDistance.GetScore());
