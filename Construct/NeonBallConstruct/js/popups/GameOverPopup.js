class GameOverPopup {
    ...
    CreateGameOverPopup(_score) {
        ...
        var yourScoreTextStyle = { fontFamily: 'Bahnschrift', fontSize: '60px', fill: '#fff', fontStyle: 'bold', align: 'left' };
        ...
        var replayTextStyle = { fontFamily: 'Bahnschrift', fontSize: '46px', fill: '#001754', fontStyle: 'bold', align: 'center' };
        ...
        var menuTextStyle = { fontFamily: 'Bahnschrift', fontSize: '46px', fill: '#001754', fontStyle: 'bold', align: 'center' };
