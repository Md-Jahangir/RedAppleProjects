...
class PlayzhubEventHandler {
    ...
    private gameType: string = 'HTML5';
    private gameName: string = "Fruit Shuffle";

    constructor() {
    }

    private emitEvent(eventName: string, data: object | null) {
        PlayzhubSDk.emitEvent(eventName, data);
    };
    ...
    SendGameStateToGame(callBackFunction: Function) {
        const eventName = 'SendGameStateToGame';
        PlayzhubSDk.listen(eventName, (data: any) => {
    ...
    //#region This will be called by Platform to send game state to game end
    ReceivedGameState(callBackFunction: Function) {
    ...
    GameStateFetch(callBackFunction: Function) {
    ...
    GameScoreFetch(callBackFunction: Function) {
    ...
    AdStarted(callBackFunction: Function) {
    ...
    AdCompleted(callBackFunction: Function) {
        const eventName = 'AdCompleted';
        PlayzhubSDk.listen(eventName, (data) => {
            callBackFunction(data);
        })
    };
    //#endregion
