...
export default class DomHandler {
    ...
    */
    ...
    /**
    * When pressed live time section reset time color.
    *  @returns {null}
    */
    //---------------------------------------------------------------
                    ...
                    if (eventHistoryResponse.data.data.length > 0) {
                        ...
                        eventHistoryResponse.data.data.forEach(element => {
                            ...
                            this.ShowPurchaseHistory(true, element.bet_type_name, posVal[0], posVal[1], posVal[2],
                                element.odds, element.bet_amount, element.win_amount, element.status,
                                element.bet_start_time, element.race_number, element.bet_result);
    ...
    * @returns {null} 
    */
    ShowPurchaseHistory(_bool, _betType, _1st, _2nd, _3rd, _odds, _betAmount,
        _winAmount, _status, _betStartTime, _raceNumber, _resultSeq) {
        if (_bool) {
            let fontRedClass = "";
