...
class Server {
    ...
    */
    constructor() {
        ...
        // this.baseUrl = "http://18.166.39.111:3004/api/v1/";//Live-Staging-IP
    ...
    ***/
    ...
    // /***
    //  * Place bet for the race number
    //  * @public
    //  * @param {string} _operator_id - id of the operator. 
    //  * @param {string} _playerToken - authenticatication token for user. 
    //  * @param {string} _playerId - id of the player. 
    //  * @param {string} _currencyCode - currency code used. 
    //  * @param {string} _userId - id of the user. 
    //  * @param {string} _sessionId - id of the session. 
    //  * @param {string} _gameId - id of the game. 
    //  * @param {string} _eventId - id of the event. 
    //  * @param {string} _betStartTime - race start time. 
    //  * @param {string} _betEndTime - race end time. 
    //  * @param {string} _betResult - result of the bet. 
    //  * @param {string} _raceNumber - race number. 
    //  * @param {string} _selectionId - bet position selected id. 
    //  * @param {string} _betId - bet id. 
    //  * @param {string} _betName - bet name. 
    //  * @param {Array} _stakeAmount - stake amount. 
    //  * @param {Array} _oddValue - odd value. 
    //  * @param {number} _betAmount - total bet amount. 
    //  * @param {string} _betStatus - current status of the bet. 
    //  * @param {string} _resultStatus - result of the bet. 
    //  * @param {string} _betLabel - lable of bet name. 
    //  * @returns {object} returns obejct {
    //     "error": true/false,
    ...
    // }
    // ***/
    // async PlaceUserBet(_operator_id, _playerToken, _playerId, _currencyCode, _userId, _sessionId,
    //     _gameId, _eventId, _betStartTime, _betEndTime, _betResult, _raceNumber, _selectionId, _betId,
    //     _betName, _stakeAmount, _oddValue, _betAmount, _betStatus, _resultStatus, _betLabel, _isLowestOdd) {
    //     let reqHeaders = new Headers();
    //     reqHeaders.append("Content-Type", "application/json");
    //     reqHeaders.append("operator_id", _operator_id);
    //     reqHeaders.append("token", this.token);
    //     let option = {
    //         player_token: _playerToken,
    //         player_id: _playerId.toString(),
    //         curency_code: _currencyCode.toString(),
    //         user_id: _userId.toString(),
    //         session_id: _sessionId,
    //         game_id: _gameId,
    //         event_id: _eventId.toString(),
    //         bet_start_time: _betStartTime,
    //         race_end_time: _betEndTime,
    //         bet_result: _betResult,
    //         race_number: _raceNumber,
    //         selection_id: _selectionId.toString(),
    //         bet_id: _betId.toString(),
    //         bet_name: _betName,
    //         stake: _stakeAmount,
    //         odds: _oddValue,
    //         amount: _betAmount.toString(),
    //         status: _betStatus,
    //         race_status: _resultStatus,
    //         bet_label: _betLabel,
    //         is_lowest: _isLowestOdd
    //     };
    //     let url = this.baseUrl + this.betPlaceUrlApi;
    //     let requestOptions = {
    //         method: 'POST',
    //         headers: reqHeaders,
    //         body: JSON.stringify(option)
...
**/
    ...
    */
    ...
    /**
    * Update the result sequence for particular user id and race number.
    * @public 
    * @param {string} _operatorId - id of the operator. 
    * @param {Number} _userId - user id.
    * @param {Number} _eventId - id of the event.
    * @param {string} _resultSeq - result sequence. 
    * @param {string} _sessionId - session id for the user. 
    * @param {string} _gameId - game id for the game. 
    * @returns {Object} - result data from KIRON Api's.
    **/
