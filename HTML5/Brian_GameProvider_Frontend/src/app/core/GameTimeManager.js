...
export default class GameTimeManager {
    /**
    * initializes variables call need function.
    * @Constructor
    */
    constructor() {
        this.allGameTime = [];
    ...
    async GameTimer() {
        if (this.timerRunning) {
            if (this.timerValue > 0) {
                if (this.timerValue < 0 || this.timerValue > 240) {
            ...
            // if (this.timerValue <= 110 && this.timerValue % 5 == 0) {
            if (this.timerValue <= 160 && this.timerValue % 5 == 0) {
                if (!this.isWinResult) {
    ...
    * @public 
    * @param {time} _data - response data
    * @returns {null} 
    */
