 ...
 * @Last_Updatd_Date :- 12-05-2022
 * @Description :- Handles betting history.
 ************************************/
...
export default class GameHistoryManager {
            ...
            responseData.data.Events.RaceEvent.forEach(element => {
                if (element.attributes.EventStatus !== "InProgress") {
                    ...
                    if (!Utils.IsEmpty(result)) {
                        ...
                        this.AddValueToGameHistoryField(element.attributes.ID, element.attributes.EventNumber, arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8], arr[9], arr[10], arr[11], arr[12], arr[13], date[0], time);
                    }
                }
            });
            Loader.HideLoader();
    ...
    * @returns {null} 
    */
    AddValueToGameHistoryField(_raceNumber, _eventNumber, _1st, _2nd, _3rd, _4th, _5th, _6th, _7th, _8th, _9th, _10th, _11th, _12th, _13th, _14th, _date, _time) {
    ...
    */
    UpdateGameHistory(element) {
        ...
        this.AddValueToGameHistoryField(responseData.attributes.ID, responseData.attributes.EventNumber, arr[0], arr[1], arr[2], arr[3], arr[4], arr[5], arr[6], arr[7], arr[8], arr[9], arr[10], arr[11], arr[12], arr[13], date[0], time);
