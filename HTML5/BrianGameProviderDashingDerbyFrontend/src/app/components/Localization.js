...
class Localization {
    ...
    SetTheTextAsPerLanguage(_languageCode) {
        switch (_languageCode) {
            case "en":
                ...
                this.placeMessageText = "Pick 1 Player which finishes either 1st or 2nd (total Players under 13)";// "Pick 1 Player which finishes either 1st or 2nd (total Players 7 and under)";// "Pick 1 Player which finishes either 1st or 2nd";
                this.showMessageText = "Pick 1 Player which finishes either 1st, 2nd or 3rd (total Players over 13)";// "Pick 1 Player which finishes either 1st, 2nd, or 3rd (total Players 8 and over)";// "Pick 1 Player which finishes among top 3";
                ...
                this.betNamePlaceText = "PLACE";
                this.betNameShowText = "SHOW";
            ...
            case "ko":
                ...
                this.searchText = "검색";
                this.betStartTimeText = "경기 시작 시간";
                ...
                this.statusText = "상태";
                this.totalPurchaseAmountText = "총 구매 금액총 경주권 구매 금액";
                this.dateText = "날짜";
                this.timeText = "시간";

                this.winMessageText = "1등 도착 1마리 적중";// "1등 도착 1두 적중";
                this.placeMessageText = "2등안 도착 1마리 적중 (13마리 이하 경주)";// "2등안 도착 1두 적중 (7두 이하)";
                this.showMessageText = "3등안 도착 1마리 적중 (14마리 이상 경주)"// "3등안 도착 1마리 적중 (8두 이상 경주)";// "3등안 도착 1두 적중 (8두 이상)";
                ...
                this.betNamePlaceText = "연승";
                this.betNameShowText = "연승";
    ...
    */
    SetValueToDomText(_languageCode) {
        // let liveVideoObj = document.getElementById("home-tab");
        // liveVideoObj.innerText = localization.liveVideoText;
        // let betSlipPurchaseObj = document.getElementById("home-tab");
        // betSlipPurchaseObj.innerText = localization.betSlipPurchaseText;

        // let gameResultObj = document.getElementById("profile-tab");
        // gameResultObj.innerText = localization.gameResultsText;

        // let oddsObj = document.getElementById("contact1-tab");
        // oddsObj.innerText = localization.oddsText;

        // let hiloObj = document.getElementById("contact-tab");
        // hiloObj.innerText = localization.hiLoText;

        // let oddEvenObj = document.getElementById("oddeven-tab");
        // oddEvenObj.innerText = localization.oddEvenText;
        ...
        // let estimateWinAmountObj = document.getElementById("heading_estimated_win_amount");
        // estimateWinAmountObj.innerText = localization.estimateWinAmountText;
        ...
        // searchRaceNumberObj.innerText = localization.raceNumberText;
        ...
        // let winOddBetNameObj = document.getElementById("win_odd_bet_name");
        // winOddBetNameObj.innerText = localization.betNameWinText;
        ...
        // let winOddChooseRaceNumObj = document.getElementById("win_odd_choose_race_number");
        // winOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let winWinningSeqObj = document.getElementById("win_odd_winning_sequence_heading");
        // winWinningSeqObj.innerText = localization.oddsWinningSequenceText;

        // let showPlaceOddBetNameObj = document.getElementById("showplace_odd_bet_name");
        // showPlaceOddBetNameObj.innerText = localization.betNameShowText;
        ...
        // let showPlaceOddChooseRaceNumObj = document.getElementById("showplace_odd_choose_race_number");
        // showPlaceOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let showPlaceWinningSeqObj = document.getElementById("showplace_odd_winning_sequence_heading");
        // showPlaceWinningSeqObj.innerText = localization.oddsWinningSequenceText;

        // let swingerOddBetNameObj = document.getElementById("swinger_odd_bet_name");
        // swingerOddBetNameObj.innerText = localization.betNameSwingerText;
        ...
        // let swingerOddChooseRaceNumObj = document.getElementById("swinger_odd_choose_race_number");
        // swingerOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let swingerWinningSeqObj = document.getElementById("swinger_odd_winning_sequence_heading");
        // swingerWinningSeqObj.innerText = localization.oddsWinningSequenceText;

        // let quinellaOddBetNameObj = document.getElementById("quinella_odd_bet_name");
        // quinellaOddBetNameObj.innerText = localization.betNameQuinellaText;
        ...
        // let quinellaOddChooseRaceNumObj = document.getElementById("quinella_odd_choose_race_number");
        // quinellaOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let quinellaWinningSeqObj = document.getElementById("quinella_odd_winning_sequence_heading");
        // quinellaWinningSeqObj.innerText = localization.oddsWinningSequenceText;

        // let exactaOddBetNameObj = document.getElementById("exacta_odd_bet_name");
        // exactaOddBetNameObj.innerText = localization.betNameExactaText;
        ...
        // let exactaOddChooseRaceNumObj = document.getElementById("exacta_odd_choose_race_number");
        // exactaOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let exactaWinningSeqObj = document.getElementById("exacta_odd_winning_sequence_heading");
        // exactaWinningSeqObj.innerText = localization.oddsWinningSequenceText;

        // let trioOddBetNameObj = document.getElementById("trio_odd_bet_name");
        // trioOddBetNameObj.innerText = localization.betNameShowTrioText;
        ...
        // let trioOddChooseRaceNumObj = document.getElementById("trio_odd_choose_race_number");
        // trioOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let trioWinningSeqObj = document.getElementById("trio_odd_winning_sequence_heading");
        // trioWinningSeqObj.innerText = localization.oddsWinningSequenceText;

        // let trifectaOddBetNameObj = document.getElementById("trifecta_odd_bet_name");
        // trifectaOddBetNameObj.innerText = localization.betNameShowTrifectaText;
        ...
        // let trifectaOddChooseRaceNumObj = document.getElementById("trifecta_odd_choose_race_number");
        // trifectaOddChooseRaceNumObj.innerText = localization.chooseRaceNumberText;
        // let trifectaWinningSeqObj = document.getElementById("trifecta_odd_winning_sequence_heading");
        // trifectaWinningSeqObj.innerText = localization.oddsWinningSequenceText;
        ...
        // let estimatedWinTag = document.createElement("i");
        // estimatedWinTag.className = "fa fa-krw";
        // estimatedWinTag.style.fontSize = "14px"
        // let currencyEstimatedWinAmountObj = document.getElementById("currency_sec_estimated_win_amount");
        // currencyEstimatedWinAmountObj.appendChild(estimatedWinTag);
        ...
        // let betCloseTimeTextObj = document.getElementById("heading_bet_close_time_more_visible");
        // betCloseTimeTextObj.innerText = localization.moreVisibleBetCloseTimeText;
        ...
        modalShowPlaceOddBetNameObj.innerText = localization.betNameShowText;
        ...
        // let howtoplaySelect1stToWinObj = document.getElementById("htp_popup_select_1st_to_win_text");
        // howtoplaySelect1stToWinObj.innerText = localization.howToPlaySelect1stToWinText;

        // let howtoplaySelect2ndObj = document.getElementById("htp_popup_select_2nd_to_win_text");
        // howtoplaySelect2ndObj.innerText = localization.howToPlaySelect2ndToWinText;

        // let howtoplaySelectBetAmountObj = document.getElementById("htp_popup_select_bet_amount_text");
        // howtoplaySelectBetAmountObj.innerText = localization.howToPlaySelectBetAmountText;

        // let howtoplayReviewBetSlipObj = document.getElementById("htp_popup_review_bet_slip_text");
        // howtoplayReviewBetSlipObj.innerText = localization.howToPlayReviewBetSlipText;

        // let howtoplayClickPlaceBetObj = document.getElementById("htp_popup_click_place_bet_text");
        // howtoplayClickPlaceBetObj.innerText = localization.howToPlayClickPlaceBetText;

        // let howtoplayAfterFinalPurchaseObj = document.getElementById("htp_popup_after_final_purchase");
        // howtoplayAfterFinalPurchaseObj.innerText = localization.howToPlayAfterFinalPurchaseText;
