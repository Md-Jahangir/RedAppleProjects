...
function GameWorld() {
    ...
    this.powerButton = new Button(
        ...
        { x: 15, y: 220 },
        () => {
            console.log("powerButton pressed: ", this.stick);
            ...
            if (this.isPressed) {
                ...
                if (this.stick.power < 75) {
                    this.stick.origin.x += 2;
                    this.stick.power += 1.2;
                    console.log("this.stick.power: ", this.stick.power);
                }
            }

        }
        // function () {
        //     console.log("powerButton pressed: ", this);
        //     if (this.stick.power < 75) {
        //         this.stick.origin.x += 2;
        //         this.stick.power += 1.2;
        //     }
...
GameWorld.prototype.draw = function () {
    ...
    // Canvas2D.drawImage(sprites.powerBar, { x: 15, y: 220 });
